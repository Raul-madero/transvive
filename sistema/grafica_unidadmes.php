...
// Create the chart
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'No conformidades por mes por Unidad ',
        align: 'left'
    },
    subtitle: {
        text:
    ...
    xAxis: {
        categories: ['<?php echo join($unidad, "','") ?>'],
        crosshair: true,
        accessibility: {
