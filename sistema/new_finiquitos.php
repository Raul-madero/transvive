...
session_start();
  ...
  $sqlopr   = "select concat(nombres, ' ', apellido_paterno, ' ', apellido_materno) as name_empleado from empleados ORDER BY apellido_paterno";
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Registro de Finiquito</h3>
              </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="inputFechabaja" name="inputFechabaja">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="inputAntiguedad" name="inputAntiguedad">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Dias Trabajados</label>
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="inputDiastrab" name="inputDiastrab">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputDiasultima" name="inputDiasultima">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Salario Diario</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputSalariodia" name="inputSalariodia">
                    </div>
                  </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-2">
                      <input type="number" step="any" class="form-control" id="inputDiasvacaciones" name="inputDiasvacaciones">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Proporcional</label>
                    <div class="col-sm-2">
                      <input type="number" step="any" class="form-control" id="inputProporvacacion" name="inputProporvacacion" value="0.00">
                    </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="inputDiasaguinaldo" name="inputDiasaguinaldo">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Proporcional</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputPorporcionaguinaldo" name="inputPorporcionaguinaldo">
                    </div>
                  </div>
                   ...
                   <div class="form-group row" style="text-align:center; background-color: #9CB1B9;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImporteusem" name="inputImporteusem">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Anguinaldo</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImporteaguinaldo" name="inputImporteaguinaldo">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImporteviajes" name="inputImporteviajes">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Vacaciones</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImporteVacaciones" name="inputImporteVacaciones">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Prima Vacacional</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImporteprimavac" name="inputImporteprimavac">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Otras Compensaciones</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImportecompensaciones" name="inputImportecompensaciones" value="0.00">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImportetotal" name="inputImportetotal">
                    </div>
                  
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Adeudos</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImporteadeudos" name="inputImporteadeudos">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImportetotalpagar" name="inputImportetotalpagar">
                    </div>
                  </div>
