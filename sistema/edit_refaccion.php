...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT id, codigo, codigo_interno, descripcion, marca, rotacion, categoria, modelo, costo, impuesto, impuesto_isr, impuesto_ieps, stock_maximo, stock_minimo, umedida, estatus FROM refacciones WHERE id = $idref");
  mysqli_close($conection);
  ...
  if($result_sqlact == 0){
    ...
    while ($data = mysqli_fetch_array($sqlact)){
      $id         = $data['id'];
      $codigo     = $data['codigo'];
      $codigointr = $data['codigo_interno'];
      $name       = $data['descripcion'];
      $unidadmed  = $data['umedida'];
      $marca      = $data['marca'];
      ...
      $imp_isr    = $data['impuesto_isr'];
      $imp_ieps   = $data['impuesto_ieps'];
      $stockmax   = $data['stock_maximo'];
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edicion Refacción/Articulo</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputCodigo" name="inputCodigo" value="<?php echo $codigo; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Codigo Interno</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputCodigoInterno" name="inputCodigoInterno" value="<?php echo $codigointr; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputDescripcion" name="inputDescripcion" value="<?php echo $name; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" style="width: 100%; text-align: left" id="inputUmedida" name="inputUmedida">
                       <option value="<?php echo $unidadmed; ?>"><?php echo $unidadmed; ?></option>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputMarca" name="inputMarca" value="<?php echo $marca; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Rotación</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputRotacion" name="inputRotacion" value="<?php echo $rotacion; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputCategoria" name="inputCategoria" value="<?php echo $categoria; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Modelo</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputModelo" name="inputModelo" value="<?php echo $modelo; ?>">
                    </div>
                  </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputCosto" name="inputCosto" value="<?php echo $costo; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Impuesto</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputImpuesto" name="inputImpuesto" value="<?php echo $impuesto; ?>">
                    </div>
                   </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputIsr" name="inputIsr" value="<?php echo $imp_isr; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">IEPS</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputIeps" name="inputIeps" value="<?php echo $imp_ieps; ?>">
                    </div>
                   </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputSmaximo" name="inputSmaximo" value="<?php echo $stockmax; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Stock Minimo</label>
                    <div class="col-sm-4">
                      <input type="number" step="any" class="form-control" id="inputSminimo" name="inputSminimo" value="<?php echo $stockmin; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" style="width: 100%; text-align: left" id="inputEstatus" name="inputEstatus">
                       <option value="<?php echo $status; ?>"><?php echo $name_status; ?></option>
