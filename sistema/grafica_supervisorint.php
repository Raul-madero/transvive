...
// Create the chart
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'No conformidades por mes por Supervisor (INTERNO)',
        align: 'left'
    },
    subtitle: {
        text:
