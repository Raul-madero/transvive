  ...
  if ($_SESSION['rol'] == 8) {
    ...
    <script type="text/javascript">
      ...
      function load_data(inicio_date, fin_date, buscaid) {
          const ajax_url = "data/datadetorders2.php";
          $.ajax({
            url: ajax_url,
            type: "POST",
            data: {
            ...
            success: function(response) {
                ...
                $('fetch_generated_wilss').DataTable({
                    "order": [[1, "desc"]],
					"dom": 'Bfrtip',
					"LengthMenu": [
						[20, 25, 50, -1],
					...
					"columns": [
						{"data": "pedidono", "width": "10px", "className": "text-right"},
						{"data": "fecha", "width": "60px", "orderable": true},
						{"data": "hora_inicio", "width": "50px", "className": "text-center", "orderable": false},
						{"data": "hora_fin", "width": "50px", "className": "text-center", "orderable": false},
						...
						{
							"render": function (data, type, full, meta) {
								return '<center> <a href+\'edit_viaje.php?id=' + full.pedidono + '\' class="btn btn-primary btn-xs"><i class="fa fa-edit" style=color:white; font-size:1.2rem"></i></a> | <a href="#" data-toggle="modal" data-target="#modalCancelViaje" data-id=\'' + full.pedidono + '\' class="btn btn-danger btn-xs"><i class=fas fa-times-circle"></i></a></center>';
							}
						}
					],
					"sDom": "<'row'><'row'><'row'><'col-md-6'l><'col-md-6'f><r>t<'row'><'col-md-4'i><'row'>p>B",
					"buttons": [
						'copyHtml5', 
						'excelHtml5', 
						'csvHtml5',
