  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Aumento de Incremento al Sueldo</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                          <div class="col-3">
                                <div class="form-group">
                                    <label>Porcentaje de Incremento al Sueldo (%):</label>
                                     <input class="form-control" type="number" id="inputEjecurporc" name="inputEjecurporc" value="0" >
                                </div>
                            </div>
                            <!--
                            <div class="col-3">
                                <div class="form-group">
                                    <label>Ejercicio Nuevo:</label>
                                   <select class="form-control" style="width: 100%; text-align: left" id="inputEjernuevo" name="inputEjernuevo">
                                        <option value="<?php echo $yearact; ?>"><?php echo $yearact; ?></option>
                      ...
                      <div class="col-3">
                      <button type="submit" class="btn btn-success" id="guardar_tipoactividad"><i class="fa fa-play"></i> Ejecutar</button>
                      </div>
                    <div class="col-3">
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var porc_aumento = $('#inputEjecurporc').val();
 
      
       var action       = 'ActualizasueldoBase';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, porc_aumento:porc_aumento},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "SUELDO BASE ACTUALIZADO CORRECTAMENTE",
                          icon: 'success',
