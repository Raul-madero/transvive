...
session_start();
  ...
  {
    header('Location: formato_noventa.php');
    mysqli_close($conection);
  }
  $idnc = $_REQUEST['id'];

  $sqlnc= mysqli_query($conection,"SELECT * FROM no_conformidades WHERE no_queja = $idnc /*and estatus = 1*/");
  mysqli_close($conection);
  $result_sqlnc = mysqli_num_rows($sqlnc);

  if($result_sqlnc == 0){
    header('Location: no_conformidades.php');
  }else{
    $option = '';
    while ($data = mysqli_fetch_array($sqlnc)){
      $idnc          = $data['id'];
      $noqueja       = $data['no_queja'];
      $fecha         = $data['fecha'];
      $mes           = $data['mes'];
      ...
      $ruta          = $data['ruta'];
      $parada        = $data['parada'];
      $date_incident = $data['fecha_incidente'];
      $turno         = $data['turno'];
      $procede_nc    = $data['procede_ac'];
      $porke_procede = $data['porque_procede'];
      $analisis      = $data['analisis_conclusionac'];
      $accion_nc     = $data['accion'];
      $date_accion   = $data['fecha_accion'];
      //*$resp_accion   = $data['responsable_accion'];
      $resp_accion   = explode(', ', $data['responsable_accion']);
      //$array_explode = explode(",", $data['responsable_accion']);
      $date_cierre   = $data['fecha_cierre'];
      $notas         = $data['observaciones'];
      $tipo          = $data['tipo_incidente'];
      $estatus_nc    = $data['estatus'];
      $cuenta        = $data['cuenta'];
      $causa         = $data['causa'];
      $afecta        = $data['afecta'];
      $depto         = $data['area_responsable'];
  ...
  //$sqlrespac   = "select concat(nombres, ' ', apellido_paterno, ' ', apellido_materno) as name_responsableac from empleados  WHERE cargo = 'supervisor' or cargo = 'jefe de operaciones' or cargo LIKE '%RH%' or cargo = 'GERENTE DE OPERACIONES' ORDER BY apellido_paterno";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edición de Quejas | No conformidades</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <input type="text" class="form-control" id="inputId" name="inputId"  value="<?php echo $idnc;?>" hidden>
               
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputNoqueja" class="col-sm-2 col-form-label">No. Queja</label>
                    <div class="col-sm-2">
                      <input style="font-size: 11pt; text-align:right; color: red" type="text" class="form-control" id="inputNoqueja" name="inputNoqueja"  value="<?php echo $noqueja;?>" >
                    </div>
                    <label for="inputFecha" class="col-sm-1 col-form-label">Fecha</label>
                    <div class="col-sm-3">
                      <input style="font-size: 10pt" type="date" class="form-control" id="inputFecha" name="inputFecha" placeholder="Descripcion de la Tarea" value="<?php echo $fecha;?>" onchange="cambiarEndDate()">
                    </div>
                    <label for="inputMes" class="col-sm-1 col-form-label">Mes</label>
                    <div class="col-sm-3">
                      <input style="font-size: 10pt" type="text" class="form-control" id="inputMes" name="inputMes" value="<?php echo $mes;?>" >
                    </div>
                  </div>
                  ...
                  <option value="<?php echo $cliente;?>" readonly selected><?php echo $cliente;?></option>
                  ...
                  <?php endforeach; ?>
                    ...
                    <label for="inputFormato" class="col-sm-2 col-form-label">8D Disciplina</label>
                      <div class="col-sm-2">
                       <input style="font-size: 10pt" type="text" class="form-control" id="inputFormato" name="inputFormato" value="<?php echo $formato;?>" >
                     </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                      ...
                      <div class="col-sm-10">
                      <textarea style="font-size: 10pt" rows="1" class="form-control" id="inputDescribe" name="inputDescribe"><?php echo $descripcion;?></textarea>
                  ...
                  <div class="form-group row" style="text-align:left;">
                      ...
                      <select class="form-control" style="width: 100%; text-align: left; font-size: 10pt" id="inputMotivo" name="inputMotivo">
                       <option value="<?php echo $motivo;?>" readonly selected><?php echo $motivo;?></option>
               ...
               <div class="form-group row" style="text-align:left;">
                  ...
                  <option value="<?php echo $responsable;?>" readonly selected><?php echo $responsable;?></option>
                  ...
                  <option value="<?php echo $supervisor;?>" readonly selected><?php echo $supervisor;?></option>
                  ...
                  <option value="<?php echo $operador;?>" readonly selected><?php echo $operador;?></option>
                  ...
                  <option value="<?php echo $ruta;?>" readonly selected><?php echo $ruta;?></option>
                  ...
                  <?php endforeach; ?>
                    ...
                    <div class="col-sm-4">
                       <input style="font-size: 10pt" type="text" class="form-control" id="inputParada" name="inputParada" value="<?php echo $parada;?>">
                    </div>
                  </div>  
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-2">
                      <input style="font-size: 10pt" type="date" class="form-control" id="inputFechainc" name="inputFechainc" value="<?php echo $date_incident;?>" >
                    </div>
                    ...
                    <div class="col-sm-3">
                      <select class="form-control" style="width: 100%; text-align: left; font-size: 10pt" id="inputTurno" name="inputTurno">
                       <option value="<?php echo $turno;?>" readonly selected><?php echo $turno;?></option>
                    ...
                    <div class="col-sm-2">
                      <select class="form-control" style="width: 100%; text-align: left; font-size: 10pt" id="inputProcede" name="inputProcede">
                       <option value="<?php echo $procede_nc;?>" readonly selected><?php echo $procede_nc;?></option>
                  ...
                  <div class="form-group row" style="text-align:left;">
                      ...
                      <div class="col-sm-10">
                      <textarea style="font-size: 10pt" rows="1" class="form-control" id="inputPorquep" name="inputPorquep"><?php echo $porke_procede;?></textarea>
                  ...
                  <div class="form-group row" style="text-align:left;">
                      ...
                      <div class="col-sm-10">
                      <textarea style="font-size: 10pt" rows="1" class="form-control" id="inputAnalisis" name="inputAnalisis"><?php echo $analisis;?></textarea>
                  ...
                  <div class="form-group row" style="text-align:left;">
                      ...
                      <select class="form-control" style="width: 100%; text-align: left; font-size: 10pt" id="inputAccion" name="inputAccion">
                       <option value="<?php echo $accion_nc;?>" readonly selected><?php echo $accion_nc;?></option>
                    ...
                    <div class="col-sm-3">
                      <input style="font-size: 10pt" type="date" class="form-control" id="inputFechaccion" name="inputFechaccion" value="<?php echo $date_accion;?>" >
                    </div>
                  ...
                  <!--<input style="font-size: 10pt" type="text" class="form-control" id="inputRespaccion" name="inputRespaccion" value="<?php echo $resp_accion;?>">-->
    ...
    <?php foreach ($filasrespac as $opra): ?>
        <option value="<?= $opra['name_responsableac'] ?>"
            <?php if (in_array($opra['name_responsableac'], $resp_accion)) echo 'selected'; ?>>
            <?= $opra['name_responsableac'] ?>
        </option>  
    <?php endforeach; ?>
</select>  
                ...
                <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                       <textarea style="font-size: 10pt" rows="1" class="form-control" id="inputObserva" name="inputObserva"> <?php echo $notas;?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row" style="text-align:left;">
                      ...
                      <select class="form-control" style="width: 100%;" name="inputTipoi" id="inputTipoi">
                        <option value="<?php echo $tipo;?>" readonly selected><?php echo $tipo;?></option>
                      ...
                      <select class="form-control" style="width: 100%;" name="inputEstatus" id="inputEstatus">
                        <option value="<?php echo $estatus_nc;?>" readonly selected><?php echo $estatus_nc;?></option>
                ...
                <!-- 
                  ...
                  -->
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-5">
                       <input style="font-size: 10pt" type="text" class="form-control" id="inputCausa" name="inputCausa" value="<?php echo $causa;?>" >
                    </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                      ...
                      <select class="form-control" style="width: 100%;" name="inputArear" id="inputArear">
                        <option value="<?php echo $depto;?>" readonly selected><?php echo $depto;?></option>
                      ...
                      <div class="col-sm-4">
                        <input style="font-size: 10pt" type="date" class="form-control" id="inputFechacierre" name="inputFechacierre" value="<?php echo $date_cierre;?>">
                      </div>
                </div>
                ...
                <div class="form-group row" style="text-align:right;">
                        <div class="offset-sm-2 col-sm-10">
                          ...
                          <button type="submit" class="btn btn-success" id="guardar_tipoactividadnc">Guardar</button>
                        </div>
                      </div>
                <!-- /.card-footer -->
              </form>
...
<script>
   $('#guardar_tipoactividadnc').click(function(e){
        e.preventDefault();
       ...
       var action       = 'AlmacenaEditNc';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, idnq:idnq, noqueja:noqueja, fecha:fecha, mes:mes, cliente:cliente, formato:formato, descripcion:descripcion, motivo:motivo, responsable:responsable, supervisor:supervisor, operador:operador, unidad:unidad, ruta:ruta, parada:parada, dateincident:dateincident, turno:turno, procede:procede, porkprocede:porkprocede, analisis:analisis, accion:accion, dateaccion:dateaccion, respaccion:respaccion, notas:notas, tipoinc:tipoinc, estatus:estatus, causa:causa, afectacte:afectacte, arearespons:arearespons, datecierre:datecierre},
