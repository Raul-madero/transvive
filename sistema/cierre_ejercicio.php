  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Cierre de Ejercicio</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                          ...
                          <div class="col-3">
                                <div class="form-group">
                                    <label>Ejercicio Actual:</label>
                                     <input class="form-control" type="number" id="inputEjeractual" name="inputEjeractual" value="<?php echo $yearact; ?>" disabled>
                                </div>
                            </div>
                      ...
                      <div class="col-3">
                      <button type="submit" class="btn btn-success" id="guardar_tipoactividad"><i class="fa fa-play"></i> Aceptar</button>
                      </div>
                    <div class="col-3">
   ...
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'ActualizaEjercicio';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, ejercicio_actual:ejercicio_actual, ejercicio_nuevo:ejercicio_nuevo},
