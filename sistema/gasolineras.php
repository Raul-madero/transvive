  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Gasolineras</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_gasolinera.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nuevo</a></li>
...
"bProcessing": true,
"sAjaxSource": "data/data_gasolineras.php",
"bPaginate":true,
...
{ mData: 'razon_social' ,"sWidth": "360px"},
{ mData: 'nombre_corto' ,"sWidth": "100px"},
{ mData: 'direccion' ,"sWidth": "160px"},
{ mData: 'telefono' ,"sWidth": "80px"},
{ mData: 'Status' ,"sWidth": "20px"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_gasolinera.php?id=' + full.id +  '\'><i class="far fa-edit"></i> Editar</a> | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-nomco=\'' + full.nombre_corto  +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="far fa-trash-alt"></i> Baja</a>';
    }
...
<script> 
  ...
  $('#modalEditcliente').on('show.bs.modal', function(e) { 
     ...
     var nombrecorto = $(e.relatedTarget).data().nomco;
  
     
    
      $(e.currentTarget).find('#form_pass_idf').val(idf);
      $(e.currentTarget).find('#form_pass_namecorto').val(nombrecorto);
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Baja de Gasolinera:</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-4 col-form-label" style="text-align: left;">Nombre corto:</label>
           <div class="col-sm-8">
              <input type="text" class="form-control" id="form_pass_namecorto" name="form_pass_namecorto"  readonly>
           </div>
        </div>  
   ...
   $('#actualizaclientes').click(function(e){
        ...
        $.ajax({
                    ...
                    //console.log(response);
                       if(response != 'error')
                      {
                        swal('Baja','Gasolinera Inactiva','success').then((value) => {
                            ...
                            console.log('no data');
                            swal('Error','Gasolinera no se puede borrar','warning').then((value) => {
