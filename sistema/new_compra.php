    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Compra</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Orden Compra</label>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                      <select style=" font-size: 14px;"  class="form-control select2bs4" style="width: 100%; text-align: left" id="inputNoreq" name="inputNoreq">
                       <option value="">No. Requision</option>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <select style=" font-size: 14px;" class="form-control select2bs4" style="width: 100%; text-align: left" id="inputProveedor" name="inputProveedor">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-8"> 
                      <input type="text" class="form-control" id="inputNofacprov" name="inputNofacprov">
                    </div>
                  </div>
                 ...
                 <div class="form-group row" >
                   ...
                   <div class="col-sm-12">
                          <table id="tablarefac" class="table table-bordered table-hover">
                          <thead>
                            <tr>
     ...
     .then(resultado => {
        if (resultado.value) {
           ...
           var norecibo  = $('#inputFolio').val();
            var action = 'procesarSalircompra';
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaCompra';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, folio:folio, noorden:noorden, noreq:noreq, fecha:fecha, proveedor:proveedor, contacto:contacto, telefono:telefono, correo:correo, forma_pago:forma_pago, metodo_pago:metodo_pago, uso_cfdi:uso_cfdi, solicita:solicita, nofactura:nofactura, notas:notas},
                      ...
                      if(response != 'error')
                        {
                           ...
                           // document.getElementById("inputProveedor").innerHTML += "<option value='"+val.(info.proveedor)+"'>"+val(info.nameprov)+"</option>"; 
                            //*$('#fpedido').disabled = true;
                            var id = (info.proveedor);
                            var name =(info.nameprov);
                           $("#inputProveedor").append("<option value='"+id+"' selected>"+name+"</option>");
                            inputNoorden.disabled = true;
                            inputNoreq.disabled = true;
...
<script type="text/javascript">
  ...
  <script>
    $('#inputNoreq').change(function(){
          //$('#disco_sel').html($(this).val() + ' - ' + $('#discos option:selected').text());
           var ordenrq  = $(this).val();
           var afolio = $('#inputFolio').val();
           var action   = 'addDetalleReqCompra';

                $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, ordenrq:ordenrq, afolio:afolio},
