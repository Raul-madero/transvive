  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Proveedores</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_proveedor.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nuevo</a></li>
               <li class="breadcrumb-item"><a href="factura/proveedores_excel.php"><i class="fas fa-file-excel"></i> Excel</a></li>
...
"columnDefs": [
                    {
                        "targets": 0, // Index of the column to hide (0-based)
                        "visible": false
                    }
                ],
"bProcessing": true,
"sAjaxSource": "data/data_proveedores.php",
"bPaginate":true,
...
"aoColumns": [
{ mData: 'id',"width": "3%" } ,
{ mData: 'no_prov', "width": "3%", "className": "dt-right"   } ,
{ mData: 'nombre', "sWidth": "25%"},
{ mData: 'nombre_corto', "sWidth": "15%"},
{ mData: 'correo', "sWidth": "10%"},
{ mData: 'telefono', "sWidth": "8%"},
{ mData: 'giro', "sWidth": "10%"},
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Baja de Proveedor</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-4 col-form-label" style="text-align: left;">Proveedor:</label>
           <div class="col-sm-8">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success pull-right" href="#" id="actualizaclientes"><i class="fa fa-save"></i>&nbsp;Baja</button>
      </div>
      </form>
    </div>
  </div>
                      ...
                      if(response != 'error')
                        {
                            ...
                            swal('Baja','Baja de Proveedor Registrada','success').then((value) => {
                            ...
                            console.log('no data');
                            swal('Error','Proveedor ya fue dado de Baja','warning').then((value) => {
