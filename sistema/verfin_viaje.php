...
session_start();
  ...
  {
    header('Location: geo_viajes.php');
    mysqli_close($conection);
  }
  $idvj = $_REQUEST['id'];

  $sqlact= mysqli_query($conection,"SELECT id, hora_fin, SUBSTRING_INDEX(ubicacion_final,',',1) latitud, SUBSTRING_INDEX(ubicacion_final,',',-1) longitud FROM registro_viajes WHERE id=$idvj");
  mysqli_close($conection);
...
function initialize() 
{
  ...
  var pos = new google.maps.LatLng(<?php echo $latitud; ?>, <?php echo $longitud; ?>);//Mi pocision
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Ubicación <small>Termino de Viaje</small>&nbsp;&nbsp;<?php echo $horafin; ?></h4>
          </div>
