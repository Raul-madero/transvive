    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Cambio de Password Firma</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Firma (password)</label>
                    <div class="col-sm-4">
...
<script>
   $('#btn_enviar_encuesta').click(function(e){
       ...
       var firmanew     = $('#inputFirma').val();
     
       var action       = 'cambiaFirma';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, firmanew:firmanew},
                      ...
                      if(response != 'error')
                        {
                         ...
                         .fire({
                          title: "Exito!",
                          text: "FIRMA CAMBIADA CORRECTAMENTE",
                          icon: 'success',
