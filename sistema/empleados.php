   ...
   $('#actualizaclientes').click(function(e){
       ...
       var action       = 'BajaEmpleado';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, idc:idc, empleado:empleado, date_baja:date_baja, mot_baja:mot_baja, recontrata:recontrata, mot_recontra:mot_recontra},
   ...
   $('#actualizaaltaclientes').click(function(e){
       ...
       var action       = 'ReingresoEmpleado';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, idc:idc, empleado:empleado, date_reing:date_reing},
