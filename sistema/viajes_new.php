...
<script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/data_comprasnaucalpan.php";
...
'pageLength'
          ...
          "columns": [
            { "data" : "counter", "width": "5%" },
             { "data" : "fecha", "width": "10%", "orderable": false },
            { "data" : "semana", "width": "5%", className: "text-right"},
           
            { "data" : "cliente", "width": "40%" },
            { "data" : "operador", "width": "10%"},
            { "data" : "semana", "width": "8%",  className: "text-right"},
           
            { "data" : "estatus", "width": "10%", className: "text-center"},

            {
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_viaje.php?id=' + full.counter +  '\'><i class="far fa-edit"></i></a> | <a href="#" data-toggle="modal" data-target="#modalCancelViaje" data-id=\'' + full.Id +  '\' href="#" class="link_delete" style="color:#94456E" ><i class="fas fa-times-circle"></i></a>';
    }
