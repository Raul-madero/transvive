  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Resumen de <small>Existencias</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
"bProcessing": true,
"sAjaxSource": "data/data_resexistencia.php",
"bPaginate":true,
"sPaginationType":"full_numbers",
"iDisplayLength": 10,  
"responsive": true,
"aoColumns": [
{ mData: 'codigo', 'sWidth': "15%"} ,
{ mData: 'codigo_interno', 'sWidth': "10%"} ,
{ mData: 'descripcion', 'sWidth': "35%"},
{ mData: 'almacen', 'sWidth': "10%"},
{ mData: 'umedida', 'sWidth': "10%"},
{ mData: 'Cantidad_Total_Disponible', 'sWidth': "10%"},
