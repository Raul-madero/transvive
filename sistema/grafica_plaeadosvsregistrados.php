  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Grafica de Viajes Planeados vs Registrados (Semana)</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/grafica_plavsreg.php?id='+ document.getElementById('inputSemana').value + 'id2='+document.getElementById('inputEjercicio').value );" >
                       
                          <button type ="button" class="btn btn-success pull-left"><i class="fas fa-chart-bar"></i> Aceptar</button>
                        </a>
                      </div>
                    <div class="col-2">
