  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte de No Ventas por Fecha</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/noventa_fcha.php?id='+ document.getElementById('fechaini').value + 'id2='+document.getElementById('fechafin').value );" >
                      ...
                      <!--
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/combustible_fchaexcel.php?id='+ document.getElementById('fechafin').value + 'id2='+document.getElementById('fechaini').value );" >
