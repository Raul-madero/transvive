              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputCategoria" name="inputCategoria" placeholder="Descripcion de la Categoria">
                    </div>
                  </div>
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "CATEGORIA ALMACENADO CORRECTAMENTE",
                          icon: 'success',
