  ...
  <div class="content-wrapper">
    ...
    <center>
       ...
       <?php
          ...
          include "../conexion.php";
          $query_folio = mysqli_query($conection,"SELECT * FROM folios where serie = 'DC'");
          $result_folio = mysqli_num_rows($query_folio);

          $folioe = mysqli_fetch_array($query_folio);
          $nuevofolio=$folioe["folio"]+1; 

          $query_upfolio = mysqli_query($conection,"UPDATE folios SET folio= folio + 1 where serie = 'DC'");
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select style=" font-size: 14px;" class="form-control" style="width: 100%; text-align: left" id="inputProveedor" name="inputProveedor" onclick="recibir();">
                 ...
                 <div class="form-group row" >
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="number" id="inputTotaldev" name="inputTotaldev">
                    </div>
                  </div>    
                ...
                <div class="form-group row" style="text-align:left;">
                        <div class="offset-sm-2 col-sm-10">
                          <a href="#"  class="btn btn-primary" data-toggle="modal" data-target="#modalDevolucion" style="color:white;" ><i class="fas fa-money-check-alt"></i> Saldar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     .then(resultado => {
        if (resultado.value) {
           ...
           var norecibo  = $('#inputFolio').val();
            var action = 'procesarSalirdevcompra';
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    if(response != 'error')
                    {
                      ...
                      location.href = 'devolucion_compra.php';
                       //*location.reload();
   ...
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaCompra';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, folio:folio, noorden:noorden, fecha:fecha, proveedor:proveedor, contacto:contacto, telefono:telefono, correo:correo, forma_pago:forma_pago, metodo_pago:metodo_pago, uso_cfdi:uso_cfdi, solicita:solicita, nofactura:nofactura, notas:notas},
