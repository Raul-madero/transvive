  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Compras <small><i class="fas fa-shopping-cart"></i></small></h4>
          </div>
          ...
          <ol class="breadcrumb float-sm-right">
            <?php
             ...
             ?> 
               <li class="breadcrumb-item"><a href="new_compra.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>

             <?php }   ?>
            
              <li class="breadcrumb-item"><a href="factura/compras_excel.php"><i class="fas fa-file-excel"></i> Excel</a></li>
          ...
          <div class="card card-success card-outline">
              ...
              <table>
                <tr>
                    ...
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>
                        <input type='text' name='gender' id='gender' placeholder="Estatus (Activa/Cancelada)">
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center; font-size: 12px;">No. Compra</th>
                <th style="text-align: center; font-size: 12px;">No. Orden</th>
                <th style="text-align: center; font-size: 12px;">No. Req.</th>
                ...
                <th style="text-align: center; font-size: 12px;">Factura</th>
                <th style="text-align: center; font-size: 12px;">Comp. Pago</th>
...
<script src="../plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_po.php";
...
<script> 
  ...
  $('#modalEditcliente').on('show.bs.modal', function(e) { 
     ...
     var dateca   = $(e.relatedTarget).data().datec;
     var idca     = $(e.relatedTarget).data().id;
     var codprov  = $(e.relatedTarget).data().codep;
     var provca   = $(e.relatedTarget).data().name;
   
     
    
      $(e.currentTarget).find('#form_pass_date').val(dateca);
      $(e.currentTarget).find('#form_pass_nocompra').val(idca);
      $(e.currentTarget).find('#form_pass_codigopv').val(codprov);
      $(e.currentTarget).find('#form_pass_provcompra').val(provca);
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Cancelar Compra</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">Fecha:</label>
           <div class="col-sm-10">
            <input type="date" class="form-control" id="form_pass_date" name="form_pass_date" disabled>
           </div>
        </div>

        <div class="form-group row">
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">No. de Compra:</label>
           <div class="col-sm-10">
            <input type="text" class="form-control" id="form_pass_nocompra" name="form_pass_nocompra" disabled>
           </div>
        </div>

        <div class="form-group row" hidden>
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">Codigo:</label>
           <div class="col-sm-10">
              <input type="text" class="form-control" id="form_pass_codigopv" name="form_pass_codigopv" disabled>
           </div>
        </div>  
        

        <div class="form-group row">
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">Proveedor:</label>
           <div class="col-sm-10">
              <input type="text" class="form-control" id="form_pass_provcompra" name="form_pass_provcompra" disabled>
           </div>
        </div> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-success pull-right" href="#" id="actualizaclientes"><i class="fa fa-save"></i>&nbsp;Cancelar Compra</button>
      </div>
      </form>
    </div>
  </div>
...
<script>
   $('#actualizaclientes').click(function(e){
        ...
        var datecompra  = $('#form_pass_date').val(); 
        var nocomprac   = $('#form_pass_nocompra').val();
        var codigoprov  = $('#form_pass_codigopv').val();
        var provcomprac = $('#form_pass_provcompra').val();

       var action       = 'CancelaCompra';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, datecompra:datecompra, nocomprac:nocomprac, codigoprov:codigoprov, provcomprac:provcomprac},
 ...
 <script> 
  $(document).ready(function (e) {
  $('#modalBorracompra').on('show.bs.modal', function(e) { 

     var datedel    = $(e.relatedTarget).data().datec;
     var iddel      = $(e.relatedTarget).data().id;
     var codprovdel = $(e.relatedTarget).data().codep;
     var provdel    = $(e.relatedTarget).data().name;
   
     
    
      $(e.currentTarget).find('#form_pass_datedel').val(datedel);
      $(e.currentTarget).find('#form_pass_nocompradel').val(iddel);
      $(e.currentTarget).find('#form_pass_codigopvdel').val(codprovdel);
      $(e.currentTarget).find('#form_pass_provcompradel').val(provdel);
   ...
   <div class="modal fade" id="modalBorracompra" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  
  
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Borrar Compra</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">Fecha:</label>
           <div class="col-sm-10">
            <input type="date" class="form-control" id="form_pass_datedel" name="form_pass_datedel" disabled>
           </div>
        </div>
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">No. de Compra:</label>
           <div class="col-sm-10">
            <input type="text" class="form-control" id="form_pass_nocompradel" name="form_pass_nocompradel" disabled>
           </div>
        </div>
        ...
        <div class="form-group row" hidden>
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">Codigo:</label>
           <div class="col-sm-10">
              <input type="text" class="form-control" id="form_pass_codigopvdel" name="form_pass_codigopvdel" disabled>
           </div>
        </div>  
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-2 col-form-label" style="text-align: left;">Proveedor:</label>
           <div class="col-sm-10">
              <input type="text" class="form-control" id="form_pass_provcompradel" name="form_pass_provcompradel" disabled>
           </div>
        </div> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-success pull-right" href="#" id="borracompra"><i class="fa fa-trash"></i>&nbsp;Borrar Compra</button>
      </div>
      </form>
    </div>
  </div>
...
<script>
   $('#borracompra').click(function(e){
        e.preventDefault();
        
        var datecompra  = $('#form_pass_datedel').val(); 
        var nocomprac   = $('#form_pass_nocompradel').val();
        var codigoprov  = $('#form_pass_codigopvdel').val();
        var provcomprac = $('#form_pass_provcompradel').val();

       var action       = 'BorraCompra';
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "COMPRA BORRADA CORRECTAMENTE",
                          icon: 'success',
