...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT ct.idusuario, ct.nombre, ct.correo, ct.usuario, ct.clave, ct.rol,
  ct.estatus, rl.rol as namerol FROM usuario ct INNER JOIN rol rl ON ct.rol = rl.idrol 
  WHERE idusuario=$idact");
  mysqli_close($conection);
     ...
     <div class="card card-secondary">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="inputName" value="<?php echo $nombre; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputUser" name="inputUser" value="<?php echo $usertb; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <select class="form-control select2bs4" style="width: 100%; text-align: left" id="inputRol" name="inputRol">
                       <option value="<?php echo $rol; ?>"><?php echo $namerol; ?></option>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaEditUsuario';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, Id:Id, name:name, mail:mail, usuario:usuario, passw:passw, rol:rol},
