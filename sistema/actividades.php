  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Tipo de Actividades</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_actividad.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
...
"bProcessing": true,
"sAjaxSource": "data/data_actividades.php",
"bPaginate":true,
...
"aoColumns": [
{ mData: 'id', "sWidth": "5%" } ,
{ mData: 'actividad' ,"sWidth": "40%"},
{ mData: 'Time' ,"sWidth": "20%"},
{ mData: 'Status' ,"sWidth": "20%"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_actividad.php?id=' + full.id +  '\'><i class="far fa-edit"></i> Editar</a> | <a id="delete_cliente" data-id=\'' + full.id +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="far fa-trash-alt"></i> Borrar</a>';
    }
