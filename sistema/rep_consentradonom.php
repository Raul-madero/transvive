  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Concentrado de Nomina</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-3">
                      <a href="#" onclick="window.open ('factura/concentrado_nomina.php?id='+ document.getElementById('inputTiponomina').value + 'id2='+document.getElementById('inputNosemana').value + 'id3='+document.getElementById('inputEjercicio').value ) ;" >
