...
<script>
   $('#guardar_Cliente').click(function(e){
       ...
       var idprov       = $('#inputId').val();
       var noprov       = $('#inputNocliente').val();
       var nameprov     = $('#inputName').val();
       ...
       var contacto     = $('#inputContactorh').val();
       var correo       = $('#inputCorreorh').val();
       ...
       var limitec      = $('#inputLimite').val();

       var action       = 'AlmacenaEditProveedor';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, idprov:idprov, noprov:noprov, nameprov:nameprov, callenum:callenum, colonia:colonia, ciudad:ciudad, municipio:municipio, estado:estado, codpostal:codpostal, pais:pais, phone:phone, contacto:contacto, correo:correo, giro:giro, phonecontac:phonecontac, servicio:servicio, sitioweb:sitioweb, razonsoc:razonsoc, rfccte:rfccte, contactocont:contactocont, emailconta:emailconta, credito:credito, condicionesc:condicionesc, limitec:limitec},
