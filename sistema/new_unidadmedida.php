    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta Unidad de Medida</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNameumedida" name="inputNameumedida" placeholder="Nombre de la Unidad de Medida">
                    </div>
                  </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var nameumedida = $('#inputNameumedida').val(); 

       var action       = 'AlmacenaUnidadmedida';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, codigo:codigo, nameumedida:nameumedida},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "UNIDAD DE MEDIDA ALMACENADA CORRECTAMENTE",
                          icon: 'success',
