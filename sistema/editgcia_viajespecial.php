...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT id, fecha, semana, cliente, ruta, operador, unidad, unidad_ejecuta, tipo_viaje, numero_unidades, num_unidad, personas, turno, valor_vuelta, hora_inicio, direccion, hora_fin, destino, hora_llegadareal, notas, estatus, costo_viaje, id_supervisor FROM registro_viajes
   WHERE id=$idact ");
  mysqli_close($conection);
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Registro de Orden de Servicio Especial</h3>
              </div>
              <div class="card-body">
                ...
                <div class="form-group row" style="text-align:left;">
                  ...
                  <div class="form-group row" style="text-align:left;" hidden>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <textarea type="date" rows="1" class="form-control" id="inputNotas" name="inputNotas" disabled><?php echo $notas;?>
                      </textarea>  
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Observaciones</label>
                    <div class="col-sm-10">
                      <textarea type="date" rows="1" class="form-control" id="inputNotasoperador" name="inputNotasoperador" >
                      </textarea>  
                    </div>
                  </div>
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "SOLICITUD DE VIAJE ESPECIAL CANCELADO CORRECTAMENTE",
                          icon: 'success',
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'RegistraViajeSpecialgcia';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, Idmov:Idmov, fecha:fecha, semana:semana, operador:operador, tipo:tipo, unidad_ejec:unidad_ejec, tipoviaje:tipoviaje, noeco:noeco, nopersonas:nopersonas, tipovuelta:tipovuelta, sueldovta:sueldovta, hora_real:hora_real, hora_finreal:hora_finreal, notasoperador:notasoperador, supervisor:supervisor},
