  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de No Ventas <small><i class="fas fa-backspace"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_noventa.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
          ...
          <div class="card card-info card-outline">
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center; font-size: 12px;">Servicio</th>
...
<!-- page script -->
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_noventa.php";
...
'pageLength'
          ...
          "columns": [
            ...
            { "data" : "importe", "width": "10%", render: $.fn.dataTable.render.number( ',', '.', 2 ), className: "text-right", "orderable":false},
            { "data" : "cliente", "width": "20%", "orderable":false },
            { "data" : "notas", "width": "25%", "orderable":false },
              
          
            {
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_noventa.php?id=' + full.pedidono +  '\'><i class="far fa-edit"></i> Editar</a> | <a href= \'noventa_fechas.php?id=' + '' + '\' ><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> Print</a> <!--| <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-name=\'' + full.pedidono +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> -->';
    }
