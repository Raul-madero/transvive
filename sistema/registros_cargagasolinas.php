...
<?php 
   if($_SESSION['rol'] == 1 || $_SESSION['rol'] == 6 || $_SESSION['rol'] == 10){
?>
...
"order": [[ 0, "asc" ]],
"bProcessing": true,
"sAjaxSource": "data/data_cargacombtemp.php",
"bPaginate":true,
"sPaginationType":"full_numbers",
"iDisplayLength": 10,
"responsive": true,
"aoColumns": [
{ mData: 'folio', "sWidth": "5px" } ,
{ mData: 'fecha', "sWidth": "5px" } ,
{ mData: 'nodesemana', "sWidth": "10px" } ,
{ mData: 'estacion' ,"sWidth": "150px"},
{ mData: 'nounidad' ,"sWidth": "80px"},
{ mData: 'placas' ,"sWidth": "50px"},
{ mData: 'operador' ,"sWidth": "100px"},
{ mData: 'supervisor' ,"sWidth": "100px"},
