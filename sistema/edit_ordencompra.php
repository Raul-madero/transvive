...
session_start();
  ...
  $sqloc   = "select id, no_requisicion from requisicion_compra where estatus = 1";
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edicion de Orden de Compra</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-2">
                     <select style=" font-size: 14px;"  class="form-control" style="width: 100%; text-align: left" id="inputNoorden" name="inputNoorden">
                       <option value="<?= $no_req ?>"><?= $no_req ?></option>
                    ...
                    <div class="col-sm-2">
                      <input style="text-align: right; font-weight: bold; color: #F05B0E" class="form-control" id="inputFolio" name="inputFolio" value="<?php echo $no_orden; ?>" readonly>
                    </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control" style="width: 100%; text-align: left; font-size: 14px;" id="inputProveedor" name="inputProveedor">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input style=" font-size: 14px;" type="text" class="form-control" id="inputTelefono" name="inputTelefono" value="<?= $phone ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Correo</label>
                    <div class="col-sm-4">
                      <input style=" font-size: 14px;" type="text" class="form-control" id="inputCorreo" name="inputCorreo" value="<?= $email ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" style="width: 100%; text-align: left" id="inputStatus" name="inputStatus">
                       <option value="<?= $estatus ?>"><?= $name_estatus ?></option> 
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action      = 'AlmacenaEditOrdencompra';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, idoc:idoc, folio:folio, noreq:noreq, fecha:fecha, proveedor:proveedor, contacto:contacto, telefono:telefono, correo:correo, forma_pago:forma_pago, metodo_pago:metodo_pago, uso_cfdi:uso_cfdi, solicita:solicita, notas:notas, recibe:recibe, status:status},
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
         ...
         <div class="form-group row" hidden>
           ...
           <div class="col-sm-9">
            <input type="text" class="form-control" id="inputfoliodet" name="inputfoliodet" value="<?php echo $no_orden; ?>" readonly>
           </div>
        </div> 
   ...
   $('#actualizaclientes').click(function(e){
       ...
       var action       = 'AddDetalleEditOrdencompra';
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, folio:folio, codigo:codigo, descripcion:descripcion, umedida:umedida, marca:marca, cantidad:cantidad, precio:precio, impuesto:impuesto, impisr:impisr, impieps:impieps, importe:importe},
    ...
    var action = 'delEditDetordencompra';
    var id_det = id;
    var folio_det = folio;
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
         ...
         <div class="form-group row" >
           ...
           <div class="col-sm-10">
            <input type="number" step="any" class="form-control" id="txt_impuesto" name="txt_impuesto" value="0">
           </div>
        </div>
        ...
        <div class="form-group row" >
           ...
           <div class="col-sm-10">
            <input type="number" step="any" class="form-control" id="txt_impuestoisr" name="txt_impuestoisr" value="0">
           </div>
        </div>
        ...
        <div class="form-group row" >
           ...
           <div class="col-sm-10">
            <input type="number" step="any" class="form-control" id="txt_impuestoieps" name="txt_impuestoieps" value="0">
           </div>
        </div>
...
<script>
   $('#actualiza_paradar').click(function(e){
        ...
        var action       = 'ActualizaEditMovordencompra';
...
<script type="text/javascript">
    $(document).ready(function(){
        var c_noorden = '<?php echo $no_orden; ?>';
        //alert(c_noorden);
        searchForDetalleditOrdencompra(c_noorden);
     });
  </script>

 <script>
 function searchForDetalleditOrdencompra(c_noorden){
    var action = 'searchForDetalleditOrdencompra';
