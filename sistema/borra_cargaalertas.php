...
session_start();
  ...
  $sqlsem = "select semana from semanas ORDER BY semana";
  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Borra Carga Alertas</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                       ...
                       <?php foreach ($filassem as $opct): //llenar las opciones del primer select ?>
                       <option value="<?= $opct['semana'] ?>"><?= $opct['semana'] ?></option>  
                       <?php endforeach; ?>
                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                   ...
                                   <select class="form-control" style="width: 100%; text-align: left" id="ejerciciofis" name="ejerciciofis">
                      ...
                      -->
                     <div class="col-2">
                      <button type="button" class="btn btn-success" id="btn_borra"> Aceptar</button>
                    </div>
                    <div class="col-2">
...
<script>
   $('#btn_borra').click(function(e){
        e.preventDefault();

       var semana          = $('#inputSemana').val();
       var ejerciciofiscal = $('#ejerciciofis').val();
      
     
       var action       = 'BorraAlertas';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, semana:semana, ejerciciofiscal:ejerciciofiscal},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "ALERTAS BORRADAS CORRECTAMENTE",
                          icon: 'success',
