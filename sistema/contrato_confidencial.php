  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Impresion de Contrato de Confidencialidad</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-3">
                      <a href="#" onclick="window.open ('factura/contrato_confidencialidad.php?id='+document.getElementById('inputOperador').value );" >
