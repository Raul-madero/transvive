  ...
  <div class="content-wrapper">
    ...
    <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edicion de Cliente</h3>
              </div>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <form class="form-horizontal">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="number" class="form-control" id="inputNocliente" name="inputNocliente" >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="inputName" name="inputName" placeholder="Nombre Comecial del Cliente" disabled>
                        </div>
                      </div>
