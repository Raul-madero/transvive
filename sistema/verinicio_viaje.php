...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT id, hora_inicio, SUBSTRING_INDEX(ubicacion,',',1) latitud, SUBSTRING_INDEX(ubicacion,',',-1) longitud FROM registro_viajes WHERE id=$idvj");
  mysqli_close($conection);
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Ubicación <small>Inicio de Viaje</small>&nbsp;&nbsp;<?php echo $horainicio; ?></h4>
          </div>
