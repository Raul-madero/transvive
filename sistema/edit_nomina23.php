   ...
   <br />
           <div class="card">
              <div class="card-header">
                <h1 class="card-title">EDICION DE NOMINA SEMANAL&nbsp;&nbsp;&nbsp;</h1>
                <div>
...
<script>
 ...
 <script>
   $('#actualizaclientes').click(function(e){
        ...
        //var semana = document.getElementById("semana").value;
         ...
         var action     = 'DeleteEmpleadoNomSemEdit';
  ...
  $('#modalEditcliente').on('show.bs.modal', function(e) { 
     ...
     var bonsem    = $(e.relatedTarget).data().bosem;
     var apoymes   = $(e.relatedTarget).data().apoym;
     var sadicl    = $(e.relatedTarget).data().sudad;
     var totlspc   = $(e.relatedTarget).data().totspc;
     var totlctol  = $(e.relatedTarget).data().totctr;
     ...
     var tottotal  = $(e.relatedTarget).data().total;
      ...
      $(e.currentTarget).find('#form_pass_bonosem').val(bonsem);
      $(e.currentTarget).find('#form_pass_apoymes').val(apoymes);
      $(e.currentTarget).find('#form_pass_sueldoad').val(sadicl);
      $(e.currentTarget).find('#form_pass_totalspc').val(totlspc);
      $(e.currentTarget).find('#form_pass_totalcontra').val(totlctol);
      ...
      $(e.currentTarget).find('#form_pass_tottotal').val(tottotal);
   ...
   <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-xs-3 bg-secondary"><input type="text" class="form-control" id="form_pass_viajspc" name="form_pass_viajspc" style="text-align:right;" readonly></div>
        <div class="col-xs-3 ">Deducciones</div>
    ...
    <div class="row">
        <div class="col-xs-3 ">Bono Semanal</div>
        <div class="col-xs-3 bg-secondary"><input type="text" class="form-control" id="form_pass_bonosem" name="form_pass_bonosem" style="text-align:right;"></div>
      </div> 
       ...
       <div class="row">
        <div class="col-xs-3 ">Sueldo Adicional</div>
        <div class="col-xs-3 bg-secondary"><input type="text" class="form-control" id="form_pass_sueldoad" name="form_pass_sueldoad" style="text-align:right;"></div>
      </div>

      <div class="row">
        <div class="col-xs-3 ">Total Especiales</div>
        <div class="col-xs-3 bg-secondary"><input type="text" class="form-control" id="form_pass_totalspc" name="form_pass_totalspc" style="text-align:right;" readonly></div>
      </div> 

      
      <div class="row">
        <div class="col-xs-3 ">Total Contrato</div>
        <div class="col-xs-3 bg-secondary"><input type="text" class="form-control" id="form_pass_totalcontra" name="form_pass_totalcontra" style="text-align:right;" readonly></div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-3 ">Sueldo Bruto</div>
      ...
      <div class="row">
        ...
        <div class="col-xs-3 bg-success"><input type="text" class="form-control" id="form_pass_tottotal" name="form_pass_totalgeneral" style="text-align:right;"></div>
      </div>
 ...
 <script>
   $('#actualizaNomempleado').click(function(e){
        ...
        var viajes_espc  = $('#form_pass_viajspc').val();
        var viajes_cto   = $('#form_pass_viajcto').val();
        ...
        var sueldo_bruto = $('#form_pass_sueldobruto').val();
        ...
        var total_total  = $('#form_pass_tottotal').val();
        
        var action     = 'ActualizaEditNomEmpleado';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, nosemana:nosemana, noempleado:noempleado, nameempleado:nameempleado, sueldo_base:sueldo_base, viajes_espc:viajes_espc, viajes_cto:viajes_cto, adeudo:adeudo, caja:caja, bono_categ:bono_categ, bono_superv:bono_superv, bono_semanal:bono_semanal, apoyo_mes:apoyo_mes, sueldo_add:sueldo_add, total_espc:total_espc, total_cto:total_cto, prima_vacac:prima_vacac, vacaciones:vacaciones, sueldo_bruto:sueldo_bruto, pago_fiscal:pago_fiscal, impuesto_fis:impuesto_fis, total_nomina:total_nomina, total_gral:total_gral, total_total:total_total},
...
"order": [[ 1, "asc" ]],     
"bProcessing": true,
"sAjaxSource": "data/data_editnominasemanal.php?id=<?php echo $idnom; ?>",
"data": { Id: Id },
"bPaginate":true,
...
"responsive": true,
"aoColumns": [
{ mData: 'no_semana', className: 'dt-left'} ,
{ mData: 'no_empleado', className: 'dt-right'} ,
{ mData: 'nombre' },
{ mData: 'cargo', className: 'dt-left' },
{ mData: 'imss', className: 'dt-left' },
{ mData: 'estatus', className: 'hidden-xs' },
{ mData: 'sueldo_base', className: 'dt-right'},
{ mData: 'viajes_especiales', className: 'dt-right',render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'viajes_contrato', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'bono_categoria', className: 'dt-right'},
{ mData: 'bono_supervisor', className: 'dt-right'},
{ mData: 'bono_semanal', className: 'dt-right'},
{ mData: 'apoyo_mensual', className: 'dt-right'},
{ mData: 'total_especiales', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'sueldo_adicional', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
...
{ mData: 'total_vueltas', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'sueldo_bruto', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'pago_fiscal', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'deduccion_fiscal', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'descuento_adeudo', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'caja', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'total_nomina', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'total_general', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'total_total', className: 'dt-right', render: $.fn.dataTable.render.number( ',', '.', 2 ), },
{ mData: 'total_general' },
],
columnDefs: [
            {
        ...
        return '<a data-toggle="modal" data-target="#modalEditcliente"  data-sem=\'' + full.no_semana +  '\' data-num=\'' + full.no_empleado +  '\' data-name=\'' + full.nombre +  '\'  data-sdb=\'' + full.sueldo_base +  '\' data-vjs=\'' + full.viajes_especiales +  '\' data-vjc=\'' + full.viajes_contrato +  '\' data-adeu=\'' + full.descuento_adeudo +  '\' data-caja=\'' + full.caja +  '\' data-bocat=\'' + full.bono_categoria +  '\' data-bosup=\'' + full.bono_supervisor +  '\' data-bosem=\'' + full.bono_semanal +  '\' data-apoym=\'' + full.apoyo_mensual +  '\' data-sudad=\'' + full.sueldo_adicional +  '\' data-totspc=\'' + full.total_especiales +  '\' data-totctr=\'' + full.total_vueltas +  '\' data-primvc=\'' + full.prima_vacacional +  '\'  data-vacaci=\'' + full.vacaciones +  '\' data-bruto=\'' + full.sueldo_bruto +  '\' data-pfiscl=\'' + full.pago_fiscal +  '\' data-dfiscl=\'' + full.deduccion_fiscal +  '\' data-totnom=\'' + full.total_nomina +  '\' data-totgral=\'' + full.total_general +  '\' data-total=\'' + full.total_total +  '\' href="javascript:void(0)" class="link_delete" style="color:#0562C1"><i class="far fa-edit"> Edita</i></a> | <a href="#" data-toggle="modal" data-target="#modalDeletecliente" data-id=\'' + full.no_empleado +  '\' data-sem=\'' + full.no_semana +  '\' href="#" class="link_delete" style="color:red" ><i class="fas fa-times-circle"> Borra</i></a>';
    },
            },
