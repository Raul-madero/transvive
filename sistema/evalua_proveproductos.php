  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Evaluación de Proveedores (Productos) <small><i class="fas fa-thumbs-up"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_evaluaprovprod.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
...
<!-- page script -->
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/dataproveedores_producto.php";
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">¿Desea Eliminar la Evaluación de Productos?</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-3 col-form-label" style="text-align: left;">No. Evaluación:</label>
           <div class="col-sm-9">
...
<script>
   $('#actualizaclientes').click(function(e){
       ...
       var action       = 'EliminaEvaluaproducto';
