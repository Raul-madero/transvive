    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Evaluaciónde Proveedores (Productos)</h3>
              </div>
              <div class="card-body">
...
<tr>
  ...
  <td>SERVICIO A DOMICILIO</td>
  <td>1 - 10</td>
  <td><input type="number" id="input10" name="input10" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="0"></td>
</tr>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaEvaluaproducto';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, tipo_eval, fecha:fecha, proveedor:proveedor, producto:producto, consulta:consulta, fecha_h1:fecha_h1, historial_h1:historial_h1, fecha_h2:fecha_h2, historial_h2:historial_h2, fecha_h3:fecha_h3, historial_h3:historial_h3, tot_compras:tot_compras, tot_calidad:tot_calidad, calif_total:calif_total, estatusc:estatusc, acciones:acciones, tiempo_res:tiempo_res, documenta:documenta, credito:credito, precios:precios, emergencia:emergencia, servicios:servicios },
  ...
  <script>
    ...
    function updateSum() {
     // alert('Function called'); // Verifica si esta alerta aparece
      ...
      var num10 = parseFloat(input10) || 0;
    /*
      var num5 = parseFloat(input5) || 0;
      var num6 = parseFloat(input6) || 0;
    */
