...
// Create the chart
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'No conformidades por mes por Motivo',
        align: 'left'
    },
    subtitle: {
        text:
    ...
    xAxis: {
        categories: ['<?php echo join($motivo, "','") ?>'],
        crosshair: true,
        accessibility: {
            description: 'Motivo'
        }
