  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Ordenes de Servicio <small><i class="far fa-file-alt"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_ordenservicio.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
         ...
         <div class="col-md-12">
          <div class="card card-info card-outline">
            ...
            <thead>
                ...
                <th style="text-align: center; font-size: 12px;">No. Cliente</th>
                <th style="text-align: center; font-size: 12px;">Cliente</th>
                <th style="text-align: center; font-size: 12px;">Tipo de Servicio</th>
                <th style="text-align: center; font-size: 12px;">Fecha de Servicio</th>
...
<!-- page script -->
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_oservicio.php";
...
'pageLength'
          ...
          "columns": [
            { "data" : "Folio", "width": "8%", className: "text-right" },
            { "data" : "fechaa", "width": "8%" },
            { "data" : "nocliente", "width": "8%" },            
            { "data" : "cliente", "width": "25%", "orderable": false},
            { "data" : "tiposervicio", "width": "10%", "orderable":false },
            { "data" : "fechaservicio", "width": "10%", "orderable":false },
        ...
        return '
        <a class="link_edit" style="color:#007bff;" href= \'edit_ordenservicio.php?id=' + full.Folio +  '\'><i class="far fa-edit"></i> Edit </a> | <a href= \'factura/orden_servicio.php?id=' + full.Folio + '\'  target="_blank"><i class="fa fa-print" style="color:#green; font-size: 1.3em"></i> Print</a> | <a data-toggle="modal" data-target="#modalSubefactura"  data-id=\'' + full.Folio +  '\' data-name=\'' + full.cliente +  '\' data-docto=\'' + full.rutar +  '\'  href="javascript:void(0)" > &nbsp;<i class="fas fa-file-upload" aria-hidden="true"></i> Router</a> | <a href=\'visorpdf_router.php?id= ' + full.Folio + '\' target="_blank">&nbsp;<i class="fa fa-eye" aria-hidden="true"></i> Router</a> <!--| <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.Folio +  '\' data-name=\'' + full.no_orden +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> -->';
    }
         ...
         {
                    "render": function ( data, type, full, meta ) {
        return '<!--<a class="link_edit" style="color:#007bff;" href= \'edit_ordenservicio.php?id=' + full.Folio +  '\'><i class="far fa-edit"></i> Edit </a> |--> <a href= \'factura/orden_servicio.php?id=' + full.Folio + '\'  target="_blank"><i class="fa fa-print" style="color:#green; font-size: 1.3em"></i> Print</a> | <!-- <a data-toggle="modal" data-target="#modalSubefactura"  data-id=\'' + full.Folio +  '\' data-name=\'' + full.cliente +  '\' data-docto=\'' + full.rutar +  '\'  href="javascript:void(0)" > &nbsp;<i class="fas fa-file-upload" aria-hidden="true"></i> Router</a> |--> <a href=\'visorpdf_router.php?id= ' + full.Folio + '\' target="_blank">&nbsp;<i class="fa fa-eye" aria-hidden="true"></i> Router</a> <!--| <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.Folio +  '\' data-name=\'' + full.no_orden +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> -->';
    }
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Carga Router</h5>
      </div>
      <div class="modal-body">

        
        <form action="insertar_doctorouter.php" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="col-md-12">
        ...
        <div class="form-group row" style="text-align:left;">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Router</label>
                     <div class="col-sm-10">
