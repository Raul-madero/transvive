  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Borra Planeacion</h2>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fechaCarga" name="fechaCarga" onchange="myFunctionDate()">
                                </div>
                            </div>
...
<script>
   $('#btn_borra').click(function(e){
       ...
       var action       = 'Borraplaneacion';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, fecha_carga:fecha_carga},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "PLANEACION BORRADA CORRECTAMENTE",
                          icon: 'success',
