  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Evaluación de Proveedores (Servicios) <small><i class="fas fa-concierge-bell"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_evaluaprovservicio.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
...
<!-- page script -->
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/dataproveedores_servicios.php";
...
'pageLength'
        ...
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_evaluaservicio.php?id=' + full.folio +  '\'><i class="far fa-edit"></i> Edit</a> |<a href= \'factura/rep_evaluaservicio.php?id=' + full.folio + '\'  target="_blank">&nbsp; <i class="fa fa-print" ></i> Print</a> | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.folio +  '\' data-name=\'' + full.atiende +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-trash"></i> Delete</a>';
    }
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">¿Desea Eliminar la Evaluación de Servicio?</h5>
      </div>
...
<script>
   $('#actualizaclientes').click(function(e){
       ...
       var action       = 'EliminaEvaluaservicio';
