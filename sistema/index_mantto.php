...
<div class="wrapper">
  ...
  <div class="container">
      ...
      <?php include('includes/navbarmantto.php') ?>
          ...
          <div class="col-lg-4 col-4">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p>Registro de Alertas</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="new_alerta.php" class="small-box-footer">Registrar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-4">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p>Solicitud de Mantenimiento</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-4 col-4">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p>Registro Carga de Combustible</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="new_cargacombustible.php" class="small-box-footer">Registrar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
