...
session_start();
  ...
  include "../conexion.php";
  $sqlenetot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'January'  ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlene= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'January'  GROUP BY unidad");
  mysqli_close($conection);

  while ($drow = mysqli_fetch_array($sqlene)){
    if(is_null($drow["unidad"])){
       $ndato1 = array("unidad","c-1");
       $ndato1n = array(0,1);
       $dato1[]=$ndato1;
       $dato1n[]=$ndato1n;
   ...
   include "../conexion.php";
  $sqlfebtot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'February'  ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlfeb= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'February'  GROUP BY unidad");
  mysqli_close($conection);

  while ($drow2 = mysqli_fetch_array($sqlfeb)){

    if(is_null($drow2["unidad"])){
       $ndato2 = array("unidad","c-1");
       $ndato2n = array(0,1);
       $dato2[]=$ndato2;
       $dato2n[]=$ndato2n;
  ...
  include "../conexion.php";
  $sqlmartot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'March'  ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlmar= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'March'  GROUP BY unidad");
  mysqli_close($conection);

  while ($drow3 = mysqli_fetch_array($sqlmar)){

    if(is_null($drow3["unidad"])){
       $ndato3 = array("unidad","c-1");
       $ndato3n = array(0,1);
       $dato3[]=$ndato3;
       $dato3n[]=$ndato3n;
  ...
  include "../conexion.php";
  $sqlabrtot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'April'  ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlabr= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'April'  GROUP BY unidad");
  mysqli_close($conection);

  while ($drow4 = mysqli_fetch_array($sqlabr)){

    if(is_null($drow4["unidad"])){
       $ndato4 = array("unidad","c-1");
       $ndato4n = array(0,1);
       $dato4[]=$ndato4;
       $dato4n[]=$ndato4n;
  ...
  include "../conexion.php";
  $sqlmaytot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'May'  ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlmay= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'May'  GROUP BY unidad");
  mysqli_close($conection);

  while ($drow5 = mysqli_fetch_array($sqlmay)){

    if(is_null($drow5["unidad"])){
       $ndato5 = array("unidad","c-1");
       $ndato5n = array(0,1);
       $dato5[]=$ndato5;
       $dato5n[]=$ndato5n;
...
include "../conexion.php";
  $sqljuntot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'June' ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqljun= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'June' GROUP BY unidad");
  mysqli_close($conection);

  while ($drow6 = mysqli_fetch_array($sqljun)){

    if(is_null($drow6["unidad"])){
       $ndato6 = array("unidad","c-1");
       $ndato6n = array(0,1);
       $dato6[]=$ndato6;
       $dato6n[]=$ndato6n;
  ...
  include "../conexion.php";
  $sqljultot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'July' ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqljul= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'July' GROUP BY unidad");
  mysqli_close($conection);

  while ($drow7 = mysqli_fetch_array($sqljul)){

    if(is_null($drow7["unidad"])){
       $ndato7 = array("unidad","c-1");
       $ndato7n = array(0,1);
       $dato7[]=$ndato7;
       $dato7n[]=$ndato7n;
  ...
  include "../conexion.php";
  $sqlagotot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'August' ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlago= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'August' GROUP BY unidad");
  mysqli_close($conection);

  while ($drow8 = mysqli_fetch_array($sqlago)){

    if(is_null($drow8["unidad"])){
       $ndato8 = array("unidad","c-1");
       $ndato8n = array(0,1);
       $dato8[]=$ndato8;
       $dindexato8n[]=$ndato8n;
  ...
  include "../conexion.php";
  $sqlseptot= mysqli_query($conection,"SELECT count(*) as num_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'September' ");
  mysqli_close($conection);
  ...
  include "../conexion.php";
  $sqlsep= mysqli_query($conection,"SELECT unidad, count(*) as n_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and MONTHNAME(fecha) = 'September' GROUP BY unidad");
  mysqli_close($conection);

  while ($drow9 = mysqli_fetch_array($sqlsep)){

    if(is_null($drow9["unidad"])){
       $ndato9 = array("unidad","c-1");
       $ndato9n = array(0,1);
       $dato9[]=$ndato9;
       $dato9n[]=$ndato9n;
...
Highcharts.chart('container', {
    ...
    title: {
        align: 'left',
        text: 'No Conformidades por Mes (Unidades)'
    },
    subtitle: {
        align: 'left',
