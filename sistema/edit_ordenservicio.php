...
if (!isset($_SESSION['idUser'])) {
  ...
  $sqlact= mysqli_query($conection,"SELECT * FROM ordenes_servicio WHERE folio=$idsol /*and estatus = 1*/");
  mysqli_close($conection);
  ...
  if($result_sqlact == 0){
    ...
    while ($data = mysqli_fetch_array($sqlact)){
      ...
      $tipo_servic  = $data['tipo_servicio'];
      $fcha_servic  = $data['fecha_servicio'];
      $contacto     = $data['contacto'];
      $email        = $data['correo_contacto'];
      $phone        = $data['telefono'];
      $cambios      = $data['cambios_especificos'];
      $requisicion  = $data['requisicion_legal'];
      $genera       = $data['genera'];
      $recibe       = $data['recibe'];
  ...
  include "../conexion.php";
  $sqlbs= mysqli_query($conection,"SELECT nombre_corto FROM clientes WHERE nombre = '$cliente'");
  mysqli_close($conection);
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edicion de Orden de Servicio</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input style="text-align:right;" type="text" class="form-control" id="inputFolio" name="inputFolio" value="<?php echo $nofolio;?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <option value="<?php echo $nocliente;?>"><?php echo $nocliente;?></option>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputDireccion" name="inputDireccion" value="<?php echo $domicilio;?>">
                    </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <select style=" font-size: 14px;" name="inputTiposerv" id="inputTiposerv" required class="form-control" >
                              <option value="<?php echo $tipo_servic;?>"><?php echo $tipo_servic;?></option>
                    ...
                    <div class="col-sm-3">
                      <input type="date" class="form-control" id="inputDateservicio" name="inputDateservicio" value="<?php echo $fcha_servic;?>">
                    </div>
                 ...
                 <div class="form-group row" >
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" id="inputContacto" name="inputContacto" value="<?php echo $contacto;?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input class="form-control" id="inputCorreo" name="inputCorreo" value="<?php echo $email;?>">
                    </div>
                     <label for="inputEmail3" class="col-sm-2 col-form-label">Telefono</label>
                    <div class="col-sm-4">
                      <input class="form-control" id="inputTelefono" name="inputTelefono" value="<?php echo $phone;?>">
                    </div>
                  </div>

                    <p style="text-align: left;"><b>CAMBIOS EN LA ESPECIFICACION TECNICA DEL SERVICIOS SOLICITADOS / OBSERVACIONES:</b></p>
                    <div class="col-sm-12">
                      <textarea class="form-control" id="inputNotas" name="inputNotas"><?php echo $cambios;?> </textarea>
                    </div>
                    ...
                    <p style="text-align: left;"><b>Requisitos legales y reglamentarios aplicables:</b></p>
                     <div class="col-sm-12">
                      <textarea class="form-control" id="inputRequisitos" name="inputRequisitos"><?php echo $requisicion;?></textarea>
                    </div>
                    <p>&nbsp;&nbsp;&nbsp;</p>
                    ...
                    <div class="col-sm-5">
                     <input class="form-control" name="inputRecibe" id="inputRecibe"  value="<?php echo $recibe;?>">
                    </div>
                  </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaEditOrdenservicio';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, id:id, folio:folio, fecha:fecha, nocliente:nocliente, cliente:cliente, direccion:direccion, tiposervicio:tiposervicio, dateservicio:dateservicio, contacto:contacto, correo:correo, telefono:telefono, notas:notas, requisitos:requisitos, genera:genera, recibe:recibe},
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
         ...
         <div class="form-group row" hidden>
           ...
           <div class="col-sm-9">
            <input type="text" class="form-control" id="inputfoliodet" name="inputfoliodet" value="<?php echo $nofolio; ?>" readonly>
           </div>
        </div> 
...
<script>
   $('#actualizaclientes').click(function(e){
        ...
        var action       = 'AddDetalleEditordenservicio';
    ...
    var action = 'delDetEditordenservicio';
    var id_det = id;
    var folio_det = folio;
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-3 col-form-label" style="text-align: left; color:#737FA7;">Hora de Salida:</label>
           <div class="col-sm-9">
...
<script>
   $('#actualiza_paradar').click(function(e){
        ...
        var action       = 'ActualizaEditDetordenserv';
...
<script type="text/javascript">
    $(document).ready(function(){
        var c_noorden = '<?php echo $nofolio; ?>';
        //alert(c_noorden);
        searchForDetalleditOservicio(c_noorden);
     });
  </script>

 <script>
 function searchForDetalleditOservicio(c_noorden){
    var action = 'searchForDetalleditOservicio';
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form id="uploadForm" action="subir-updateimagenoserv.php" method="post" enctype="multipart/form-data" target="uploadFrame">
