  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Compras</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
"bProcessing": true,
"sAjaxSource": "data/data_compras.php",
"bPaginate":true,
