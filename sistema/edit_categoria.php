...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT id, categoria FROM categorias WHERE id=$idact");
  mysqli_close($conection);
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edición de Categoria</h3>
              </div>
              <div class="card-body">
              ...
              <input type="hidden" class="form-control" id="inputId" name="inputId" value="<?php echo $id; ?>">
                <div class="card-body">
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputCategoria" name="inputCategoria" placeholder="Descripcion de la Categoria" value="<?php echo $categoria; ?>">
                    </div>
                  </div>
...
<script>
   $('#guardar_motivo').click(function(e){
       ...
       var action       = 'AlmacenaEditCategoria';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, Id:Id, categoria:categoria},
