            ...
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-3">
                      <a href="#" onclick="window.open ('factura/rep_adeudosnomina.php?id='+ document.getElementById('inputTiponomina').value + 'id2='+document.getElementById('semana').value + 'id3='+document.getElementById('semana2').value + 'id4='+document.getElementById('inputEjercicio').value );" >  
