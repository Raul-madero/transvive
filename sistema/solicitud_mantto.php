  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Orden de Trabajo de Mantenimiento</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
"bProcessing": true,
"sAjaxSource": "data/data_solicitudmantto.php",
"bPaginate":true,
...
{ mData: 'solicita' ,},
{ mData: 'tipo_trabajo' ,},
{ mData: 'tipo_mantenimiento' ,},
{ mData: 'Status' ,},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_solicitudmantto.php?id=' + full.id +  '\'><i class="far fa-edit"></i> Editar</a> | <a href= \'factura/form_ordenmantto.php?id=' + full.no_orden + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i>Print</a> | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-name=\'' + full.no_orden +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a>';
    }
