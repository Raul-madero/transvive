  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Solicitud de Credito  <small><i class="fas fa-money-check-alt"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_solicitudcredito.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
          ...
          <div class="card card-info card-outline">
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center; font-size: 12px;">Regimen</th>
                <th style="text-align: center; font-size: 12px;">Monto</th>
                <th style="text-align: center; font-size: 12px;">Plazo</th>
...
<!-- page script -->
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_solicitacred.php";
...
'pageLength'
          ...
          "columns": [
            ...
            { "data" : "fechaa", "width": "10%" },
            { "data" : "empresa", "width": "30%" },            
            { "data" : "Regimen", "width": "10%", "orderable": false},
            { "data" : "Monto", "width": "10%", "orderable": false},
            { "data" : "Plazo", "width": "10%", "orderable": false},
            { "data" : "estatusped", "width": "10%" },
              
          
            {
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_solicitudcredito.php?id=' + full.pedidono +  '\'><i class="far fa-edit"></i> Editar</a> | <a href= \'factura/rep_solicitudcredito.php?id=' + full.pedidono + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> Print</a> <!--| <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-name=\'' + full.no_orden +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> -->';
    }
