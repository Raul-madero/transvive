  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Actualiza Sueldos en Vueltas</h2>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-2">
                          ...
                          <button type ="button" class="btn btn-primary pull-left" id="idacepta"><i class="fa fa-check"></i> Aceptar</button>
                       
                      </div>
                    <div class="col-2">
                      <a href="#" onclick="window.location ='viajes.php';" >
...
<script>
    $(document).ready(function () {
        $("#idacepta").on('click', function () { 
            
            var nosemana     = $('#inputSemana').val();        
            alert(nosemana);
            var action = 'ActualizaSueldosVuelta';
         ...
         $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, nosemana:nosemana},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "SUELDOS DE VIAJES ACTUALIZADOS CORRECTAMENTE",
                          icon: 'success',
