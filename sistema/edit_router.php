...
session_start();
  ...
  $sql1= mysqli_query($conection,"SELECT * FROM routers WHERE folio = $id");
  mysqli_close($conection);
  ...
  if($result_sql1 == 0){
    ...
    while ($data = mysqli_fetch_array($sql1)){
      ...
      $ruta       = $data['ruta'];
      $hllegada_1 = $data['horallegada_t1'];
      $hllegada_2 = $data['horallegada_t2'];
      $hllegada_3 = $data['horallegada_t3'];
      $liga_maps  = $data['liga_maps'];
      ...
      $foto  = $data['foto'];
       ...
       $classRemove = 'notBlock';
        ...
        //$data_producto = mysqli_fetch_assoc($sqlprod);
      
          $fotoact = '<img id="img" src="img/routers/'.$data['foto'].'" >';
...
<div class="wrapper">
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edición de Router</h3>
              </div>
              <div class="card-body">
              <div class="card-header p-2">
              <!-- /.card-header -->
              <!-- form start -->
               <form name="form_new_cliente_venta" id="form_new_cliente_venta"  action="valida_edicionrouter.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group row">  
                   <div class="col-md-12" hidden>
                    <div class="input-group">
                      ...
                      <input name="ffolio" id="ffolio" type="text" class="form-control" style="text-align:right;" value="<?php echo $folio; ?>" readonly>
                    </div>
             </div>
            </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" style="width: 100%; text-align: left" id="inputCliente" name="inputCliente">
                       <option value="<?php echo $folio; ?>"><?php echo $cliente; ?></option>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-2">
                      <input type="time" class="form-control" id="inputHorallegat1" name="inputHorallegat1" value="<?php echo $hllegada_1; ?>" >
                    </div>
                    ...
                    <div class="col-sm-2">
                      <input type="time" class="form-control" id="inputHorallegat2" name="inputHorallegat2" value="<?php echo $hllegada_2; ?>">
                    </div>
                    ...
                    <div class="col-sm-2">
                      <input type="time" class="form-control" id="inputHorallegat3" name="inputHorallegat3" value="<?php echo $hllegada_3; ?>">
                    </div>
                  </div>
                  <br>
      ...
      <thead>
        ...
        <tr>
          ...
          <th width="10%" style="text-align: center;">No. Paradas</th>
          <th colspan="2" style="text-align: center;" ><a style="text-align: center; color:#0562C1; font-size: 2.2em;" href="#" id="alumno" data-target="#modalAlumnoMuestra" data-toggle="modal">
                      <small> + </small>
                  </a></th>
        </tr>
      </thead>
  ...
  <br>
              ...
              <div class="photo">
                 <label style="color:#5D6D7E;" for="foto">Foto</label>
                    <div class="prevPhoto">
                       ...
                       <label for="foto"><?php echo $fotoact; ?></label>
                    </div>
                    <div class="upimg">
                        <input type="file" name="foto" id="foto" value="<?php echo $fotoact; ?>">
                    </div>
     ...
     <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" style="width: 100%; text-align: left" id="inputLigamaps" name="inputLigamaps" placeholder="Pegue aqui la liga de google maps" value="<?php echo $liga_maps; ?>">
                    </div>
                  </div>
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
          <div class="form-group"> 
           ...
           <div class="col-md-12">
                    <div class="input-group">
                      <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Folio:</i></span>
                      <input name="bookId" id="bookId" type="text" class="form-control" style="text-align:right;"/ value="<?php echo $folio; ?>" disabled>
                    </div>
             </div>
        <div class="col-md-12">
          <div class="form-group"> 
        ...
        <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> No. Paradas:</i>&nbsp;&nbsp;</span>
...
<script>
   $('#actualiza_partidamd').click(function(e){
       ...
       var action       = 'ActualizaDetalleEditrouter';
...
<script> 
    ...
    var action = 'removeDetalleEditRouter';
    var id_partida = id;
    var folio = folio;
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //alert(c_noorden);
        searchForDetalleditRouter(c_folio);
     });
  </script>

 <script>
 function searchForDetalleditRouter(c_folio){
    var action = 'searchForDetalleditRouter';
    var nofolio = c_folio;
...
<script> 
  ...
  $('#modalIndicadorouter').on('show.bs.modal', function(e) {    
     var foliop    = $(e.relatedTarget).data().folio;
     var ider      = $(e.relatedTarget).data().id;
     var hora1     = $(e.relatedTarget).data().ht1;
     var hora2     = $(e.relatedTarget).data().ht2;
     var hora3     = $(e.relatedTarget).data().ht3;
     var eparada   = $(e.relatedTarget).data().pard;
     var erefcia   = $(e.relatedTarget).data().refcia;
     var enoparad  = $(e.relatedTarget).data().nopard;
    
      $(e.currentTarget).find('#txt_foliop').val(foliop);
      $(e.currentTarget).find('#txt_id').val(ider);
      $(e.currentTarget).find('#txt_horario1').val(hora1);
      $(e.currentTarget).find('#txt_horario2').val(hora2);
      $(e.currentTarget).find('#txt_horario3').val(hora3);
      $(e.currentTarget).find('#txt_parada').val(eparada);
      $(e.currentTarget).find('#txt_referencia').val(erefcia);
      $(e.currentTarget).find('#txt_noparadas').val(enoparad);
...
<div class="modal fade" id="modalIndicadorouter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  
  
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Edita Parada</h5>
      </div>
      <div class="modal-body">
        <form>
        ...
        <div class="col-md-12">
          <div class="form-group"> 
           ...
           <div class="col-md-12" hidden>
             ...
             <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Folio:</i>&nbsp;&nbsp;</span>
                <input type="text"  class="form-control" name="txt_foliop" id="txt_foliop" readonly>
              </div>
         </div>  
           ...
           <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Horario Turno 1:</i>&nbsp;&nbsp;</span>
                <input type="time"  class="form-control" name="txt_horario1" id="txt_horario1" >
              </div>
         </div>  
         ...
         <div class="col-md-12">
          ...
          <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Horario Turno 2:</i>&nbsp;&nbsp;</span>
                <input type="time"  class="form-control" name="txt_horario2" id="txt_horario2" >
              </div>
         </div>
         ...
         <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Horario Turno 3:</i>&nbsp;&nbsp;</span>
                <input type="time"  class="form-control" name="txt_horario3" id="txt_horario3" >
              </div>
         </div>
        ...
        <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Parada: </i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <input type="text" class="form-control" name="txt_parada" id="txt_parada" >
              </div>
         </div>
        ...
        <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> Referencia: </i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <input type="text" class="form-control" name="txt_referencia" id="txt_referencia" >
              </div>

          <div class="col-md-12">
              <div class="input-group">
                <span class="input-group-addon form-required"><i class="fa" style="color:#737FA7;"> No. Paradas:</i>&nbsp;&nbsp;</span>
                <input type="number" class="form-control" name="txt_noparadas" id="txt_noparadas" value="0">
              </div>
         </div>
...
<script>
   $('#actualiza_paradar').click(function(e){
        ...
        var folio_p      = $('#txt_foliop').val();
        var idpard       = $('#txt_id').val();
        var horario1pd   = $('#txt_horario1').val();
        var horario2pd   = $('#txt_horario2').val();
        var horario3pd   = $('#txt_horario3').val();
        var paradart     = $('#txt_parada').val();
        var referenciapd = $('#txt_referencia').val();
        var noparadaspd  = $('#txt_noparadas').val();
       

        var action       = 'ActualizaParadarouter';
    
        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, folio_p:folio_p, idpard:idpard, horario1pd:horario1pd, horario2pd:horario2pd, horario3pd:horario3pd, paradart:paradart, referenciapd:referenciapd, noparadaspd:noparadaspd},
                     ...
                     if(response != 'error')
                        {
                            ...
                            $('#fparada').val('');
                            $('#fnparadas').val('');
                            $('#modalIndicadorouter').modal('hide');
