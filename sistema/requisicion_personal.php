  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Requisiciones de Personal <small><i class="fas fa-id-badge"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_reqpersonal.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
             <!-- <li class="breadcrumb-item"><a href="#"><i class="fas fa-file-excel"></i> Excel</a></li>-->
             <li class="breadcrumb-item"><a href="factura/reqpersonal_excel.php"><i class="fas fa-file-excel"></i> Excel</a></li>
          ...
          <div class="card card-success card-outline">
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center; font-size: 12px;">Fecha Elaboración</th>
                <th style="text-align: center; font-size: 12px;">Fecha Recepción</th>
                <th style="text-align: center; font-size: 12px;">Puesto</th>
                <th style="text-align: center; font-size: 12px;">Zona</th>
                <th style="text-align: center; font-size: 12px;">Supervisor</th>
                <th style="text-align: center; font-size: 12px;">No. Vacantes</th>
                <th style="text-align: center; font-size: 12px;">Motivo Vacante</th>
   ...
   ?>
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_reqpersonal.php";
...
'pageLength'
          ...
          "columns": [
            ...
            { "data" : "fechaa", "width": "5%", className: "text-center" },
            { "data" : "fecha_rec", "width": "8%", className: "text-center" },
            { "data" : "puesto", "width": "5%" },
            { "data" : "zona", "width": "10%", "orderable":false },
            { "data" : "supervisor", "width": "15%", },
            { "data" : "vacantes", "width": "8%", className: "text-left", "orderable":false },
            { "data" : "motivo", "width": "20%", "orderable":false },
        ...
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_reqpersonal.php?id=' + full.pedidono +  '\'><i class="far fa-edit"></i> Edit</a> | <a href= \'factura/rep_reqpersonal.php?id=' + full.pedidono + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> Print</a> | <a data-toggle="modal" data-target="#modalCancela"  data-id=\'' + full.pedidono +  '\' data-date=\'' + full.fechaa +  '\' data-name=\'' + full.puesto +  '\' href="javascript:void(0)">&nbsp;<i class="fa fa-ban"></i></a> | <a data-toggle="modal" data-target="#modalBorra"  data-id=\'' + full.pedidono +  '\' data-name=\'' + full.puesto + '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-trash"></i> Delete</a> ';
    }
...
'pageLength'
          ...
          "columns": [
            ...
            { "data" : "zona", "width": "8%", "orderable":false },
            { "data" : "supervisor", "width": "15%", },
            { "data" : "vacantes", "width": "8%", className: "text-left", "orderable":false },
            { "data" : "motivo", "width": "20%", "orderable":false },
            { "data" : "estatusped", "width": "8%", "orderable":false },
          ...
          
            {
                    ...
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_reqpersonal.php?id=' + full.pedidono +  '\'><i class="far fa-edit"></i> </a> | <a href= \'factura/rep_reqpersonal.php?id=' + full.pedidono + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> </a> | <a data-toggle="modal" data-target="#modalCancela"  data-id=\'' + full.pedidono +  '\' data-date=\'' + full.fechaa +  '\' data-name=\'' + full.puesto +  '\' href="javascript:void(0)">&nbsp;<i class="fa fa-ban"></i></a> | <a data-toggle="modal" data-target="#modalBorra"  data-id=\'' + full.pedidono +  '\' data-name=\'' + full.puesto +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-trash"></i> </a> ';
    }
...
<script> 
  ...
  $('#modalEditcliente').on('show.bs.modal', function(e) { 
     ...
     var tiporeq  = $(e.relatedTarget).data().name;
      ...
      $(e.currentTarget).find('#form_pass_puestoreq').val(tiporeq);
...
<script>
  ...
  $('#modalBorra').on('show.bs.modal', function(e) { 
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Borrar Requisicion de Personal</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-3 col-form-label" style="text-align: left;">Puesto:</label>
           <div class="col-sm-9">
...
<script>
                       ...
                       if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                          if ($mensaje === undefined)
                          {
                            ...
                            bootbox.alert({
                                message: 'REQUISICION DE PERSONAL BORRADA!',
                                callback: function () {
  ...
  $('#modalCancela').on('show.bs.modal', function(e) { 
     ...
     var namepc    = $(e.relatedTarget).data().name;
      ...
      $(e.currentTarget).find('#form_pass_puesto').val(namepc);
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Cancela Requisicion de Personal</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-3 col-form-label" style="text-align: left;">Puesto:</label>
           <div class="col-sm-9">
              <input type="text" class="form-control" id="form_pass_puesto" name="form_pass_puesto">
           </div>
        </div>
...
<script>
   $('#cancelarequisicion').click(function(e){
        ...
        var puestosc   = $('#form_pass_puesto').val();
        var motivoc    = $('#form_pass_motivoc').val();

        var action       = 'CancelarequisicionPersonal';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, noreqc:noreqc, daterc:daterc, puestosc:puestosc, motivoc:motivoc},
                       ...
                       if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                          if ($mensaje === undefined)
                          {
                            ...
                            bootbox.alert({
                                message: 'REQUISICION DE PERSONAL CANCELADA!',
                                callback: function () {
