  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Pagos a Proveedor <small><i class="fas fa-file-invoice-dollar"></i></small></h4>
          </div>
          ...
          <ol class="breadcrumb float-sm-right">
            <?php
             ...
             ?> 
               <li class="breadcrumb-item"><a href="new_pagoprov.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nuevo</a></li>
          ...
          <div class="card card-success card-outline">
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center; font-size: 12px;">No. Pago</th>
...
<script src="../plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_podpay.php";
