    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta Unidad</h3>
              </div>
              <div class="card-body">
              <div class="card-header p-2">
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insertar_unidad.php" method="post" class="form-horizontal" enctype="multipart/form-data">
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNounidad" name="inputNounidad" placeholder="Ejemplo T-01">
                    </div>
                  </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSocio" name="inputSocio">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputNserie" name="inputNserie" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNopoliza" name="inputNopoliza" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputAseguradora" name="inputAseguradora">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="inputIniciopol" name="inputIniciopol" >
                    </div>

                    <label for="inputEmail3" class="col-sm-2 col-form-label">Fin Poliza</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="inputFinpol" name="inputFinpol" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputTarjetac" name="inputTarjetac" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-8">
                      <input type="date" class="form-control" id="inputVencetar" name="inputVencetar" >
                    </div>
                  </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-8">
                      <input type="date" class="form-control" id="inputEntregadoc" name="inputEntregadoc" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="number" step="any" class="form-control" id="inputParametro" name="inputParametro" placeholder="Rendimiento Estandar">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNotas" name="inputNotas" >
                    </div>
                  </div>
                ...
                <div class="form-group row" style="text-align:left;">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Tarjeta de  circulación</label>
                     <div class="col-sm-10">
                     <input class="form-control prevPhoto" type="file" name="archivo_tarjetac"  />
                </div>
             </div>
             ...
             <div class="form-group row" style="text-align:left;">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Permisos</label>
                     <div class="col-sm-10">
                     <input class="form-control prevPhoto" type="file" name="archivo_permisos"  />
                </div>
             </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var parametro    = $('#inputParametro').val();
       ...
       var action       = 'AlmacenaUnidad';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, nounidad:nounidad, socio:socio, descripcion:descripcion, nplacas:nplacas, nserie:nserie, year:year, tipogas:tipogas, nopoliza:nopoliza, aseguradora:aseguradora, iniciapol:iniciapol, terminapol:terminapol, notarjeta:notarjeta, vencetarjeta:vencetarjeta, entregadoc:entregadoc, parametro:parametro, notas:notas},
