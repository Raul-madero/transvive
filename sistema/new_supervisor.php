    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta Supervisor</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNombres" name="inputNombres" placeholder="Nombre(s)">
                    </div>
                  </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaSupervisor';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, nombres:nombres, paterno:paterno, materno:materno, phone:phone},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "SUPERVISOR ALMACENADO CORRECTAMENTE",
                          icon: 'success',
