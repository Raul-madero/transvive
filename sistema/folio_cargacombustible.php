...
$sqlact= mysqli_query($conection,"SELECT serie, folio from folios where serie = 'CC'");
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Folio Carga Combustible</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <input type="hidden" class="form-control" id="inputSerie" name="inputSerie" value="<?= $serie ?>">
               
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Folio</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="inputFolio" name="inputFolio" value="<?= $folioom ?>">
                    </div>
                  </div>
                ...
                <div class="form-group row" style="text-align:left;">
                        <div class="offset-sm-2 col-sm-10">
                          ...
                          <button type="submit" class="btn btn-success" id="btn_enviar_encuesta"> Aceptar</button>
                        </div>
                      </div>
                <!-- /.card-footer -->
              </form>
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    if(response != 'error')
                    {
                      ...
                      location.href = 'index_almacen.php';
                       //*location.reload();
...
<script>
   $('#btn_enviar_encuesta').click(function(e){
       ...
       var folio_om     = $('#inputFolio').val();
       var serie_om     = $('#inputSerie').val();

       var action       = 'cambiaFolioom';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, serie_om:serie_om, folio_om:folio_om},
