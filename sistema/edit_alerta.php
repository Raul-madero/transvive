...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT id, fecha, semana, cliente, unidad, operador, noalertas, velocidad, limite FROM alertas
   WHERE id=$idact");
  mysqli_close($conection);
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edición de Alerta</h3>
              </div>
              <div class="card-body">
              ...
              <form class="form-horizontal">
                <input type="hidden" class="form-control" id="inputId" name="inputId" value="<?= $id ?>">
              <div class="form-group row">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" style="width: 100%; text-align: left" id="inputSemana" name="inputSemana">
                       <option value="<?= $nosemana ?>"><?= $nosemana ?></option>
                  ...
                  <div class="form-group row" style="text-align:left;">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputAlertas" name="inputAlertas" value="<?= $noalertas ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputVelocidad" name="inputVelocidad" value="<?= $velocidad ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputLimite" name="inputLimite" value="<?= $limite ?>">
                    </div>
                  </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaEditAlerta';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, Ida:Ida, semana:semana, unidad:unidad, operador:operador, alertas:alertas, velocidad:velocidad, limite:limite},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "ALERTA EDITADA CORRECTAMENTE",
                          icon: 'success',
