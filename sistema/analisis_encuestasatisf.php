  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte de Analisis de Encuesta Satisfacción</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/analisis_encuestasa1.php?id='+ document.getElementById('inputMes').value);" >
                      ...
                      ?>
                    <div class="col-2">
                      <a href="#" onclick="window.location ='index_calidad.php';" >
