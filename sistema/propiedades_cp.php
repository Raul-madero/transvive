  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Propiedad del Cliente o Proveedor  <small><i class="fas fa-car-alt"></i></small></h4>
          </div>
          <div class="col-sm-6 d-none d-sm-block">
          <ol class="breadcrumb float-sm-right">
            
             <li class="breadcrumb-item"><a href="new_propiedadcp.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
          ...
          <div class="card card-info card-outline">
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center; font-size: 12px;">Fecha Entrega</th>
                <th style="text-align: center; font-size: 12px;">Empresa</th>
                <th style="text-align: center; font-size: 12px;">Bien entregado</th>
...
<!-- page script -->
    ...
    <script type="text/javascript">
      ...
      function load_data(initial_date, final_date, gender){
        var ajax_url = "data/datadetorders_propiedad.php";
