...
include "../conexion.php";
  ...
  if ($vjs_planeados == 0) {
      ...
      $p_registrados    = ($vjs_planeados / $nv_registrados) * 100;
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header"><?php echo $nv_registrados; ?></h5>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="description-block border-right">
                      ...
                      <h5 class="description-header"><?php echo $consumo_mes; ?></h5>
