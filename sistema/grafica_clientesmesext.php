...
session_start();
  ...
  $sqltot= mysqli_query($conection,"SELECT count(*) as tot_quejas FROM no_conformidades WHERE YEAR(fecha) = YEAR(CURDATE()) and tipo_incidente = 'EXTERNO' ");
...
// Create the chart
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'No conformidades por Cliente por Mes (MOTIVO EXTERNO)',
        align: 'left'
    },
    subtitle: {
        text:
