...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT * FROM clientes WHERE id = $noempl");
  mysqli_close($conection);
  ...
  if($result_sqlact == 0){
    ...
    while ($data = mysqli_fetch_array($sqlact)){
      ...
      $contacto_conta = $data['contacto_conta'];
      $correo_conta   = $data['email_conta'];
      $calle          = $data['calle'];
      ...
      $condicionesc   = $data['condiciones_credito'];
      $idsuper        = $data['id_supervisor'];
      $movil          = $data['movil'];
      $sitio          = $data['sitio'];
      $tipo_contrato  = $data['tipo_contrato'];
      $fchainico      = $data['fecha_iniciacontrato'];
      $fchafinco      = $data['fecha_fincontrato'];
  ...
  include "../conexion.php";
  $sqlmov= mysqli_query($conection,"SELECT count(*) as numreg FROM registro_viajes WHERE cliente = '$nombre_corto'");
  mysqli_close($conection);
  $result_sqlmov = mysqli_num_rows($sqlmov);
  
    while ($datamov = mysqli_fetch_array($sqlmov)){
      $noreg = $datamov['numreg'];
  ...
  include "../conexion.php";
  $sqlact= mysqli_query($conection,"SELECT nombre FROM usuario WHERE idusuario = $idsuper");
  mysqli_close($conection);
  $result_sqlact = mysqli_num_rows($sqlact);
  
    while ($data1 = mysqli_fetch_array($sqlact)){
      $namesuperv = $data1['nombre'];
              ...
              <div class="card-body">
                <div class="tab-content">
                    ...
                    <form class="form-horizontal">
                      <input type="hidden" class="form-control" id="inputId" name="inputId" value="<?php echo $id; ?>">
                       <div class="form-group row">
                        <label for="inputNocliente" class="col-sm-3 col-form-label" style="text-align: left;">No. Cliente:</label>
                        <div class="col-sm-9">
                          <input type="number" class="form-control" id="inputNocliente" name="inputNocliente" value="<?php echo $nocliente; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="inputName" name="inputName" placeholder="Nombre Comecial del Cliente" value="<?php echo $nombre_corto; ?>"  <?php echo $activati; ?>>
                        </div>
                      </div>

                      <div class="form-group row">
                        <label for="inputCallenum" class="col-sm-3 col-form-label" style="text-align: left;">Calle y Numero:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputColonia" class="col-sm-3 col-form-label" style="text-align: left;">Colonia:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputCiudad" class="col-sm-3 col-form-label" style="text-align: left;">Ciudad:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputMunicipio" class="col-sm-3 col-form-label" style="text-align: left;">Municipio:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputEstado" class="col-sm-3 col-form-label" style="text-align: left;">Estado:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputEstado" name="inputEstado"  value="<?php echo $estado; ?>">
                        </div>
                        <label for="inputCpostal" class="col-sm-3 col-form-label" style="text-align: left;">Codigo Postal:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputCpostal" name="inputCpostal" value="<?php echo $codpostal; ?>">
                        </div>
                      </div>

                         <div class="form-group row" hidden>
                        <label for="inputPais" class="col-sm-1 col-form-label" style="text-align: left;">País:</label>
                        <div class="col-sm-5">
                      ...
                      <div class="form-group row">
                      <label for="inputPhone" class="col-sm-3 col-form-label" style="text-align: left;">Numero de Teléfono (con Lada):</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                      <label for="inputContactorh" class="col-sm-3 col-form-label" style="text-align: left;">Contacto RH/Compras:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                      <label for="inputCorreorh" class="col-sm-3 col-form-label" style="text-align: left;">Correo Electrónico RH/Compras:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                      <label for="inputTelcontacto" class="col-sm-3 col-form-label" style="text-align: left;">Número de Teléfono de Contacto:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                      <label for="inputGiro" class="col-sm-3 col-form-label" style="text-align: left;">Giro de la empresa:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row" hidden>
                      <label for="inputServicio" class="col-sm-3 col-form-label" style="text-align: left;">Tipo de Servicio:</label>
                        <div class="col-sm-9">
                       ...
                       <div class="form-group row">
                      <label for="inputSitioweb" class="col-sm-3 col-form-label" style="text-align: left;">Sitio Web:</label>
                        <div class="col-sm-9">
                       ...
                       <div class="form-group row">
                      <label for="inputTipocontrato" class="col-sm-3 col-form-label" style="text-align: left;">Tipo de Contrato:</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="inputDateini" class="col-sm-3 col-form-label" style="text-align: left;">Inicio Contrato:</label>
                        <div class="col-sm-3">
                          <input type="date" class="form-control" id="inputDateini" name="inputDateini" value="<?php echo $fchainico; ?>">
                        </div>
                        <label for="inputDatefin" class="col-sm-3 col-form-label" style="text-align: left;">Fin Contrato:</label>
                        <div class="col-sm-3">
                          <input type="date" class="form-control" id="inputDatefin" name="inputDatefin" value="<?php echo $fchafinco; ?>">
                        </div>
                      </div>

                      <div class="form-group row">
                      <label for="fsupervisor" class="col-sm-3 col-form-label" style="text-align: left;">Jefe de Operaciones:</label>
                        <div class="col-sm-9">
                          <select class="form-control" style="width: 100%;" name="fsupervisor" id="fsupervisor">
                  <option value="<?php echo $idsuper; ?>"><?php echo $namesuperv; ?></option>
                  ...
                  <div class="tab-pane" id="timeline">
                    ...
                    <form class="form-horizontal">
                    <div class="form-group row">
                        <label for="inputRazonsoc" class="col-sm-3 col-form-label" style="text-align: left;">Razón Social:</label>
                        <div class="col-sm-9">
                          <input type="email" class="form-control" id="inputRazonsoc" name="inputRazonsoc"  value="<?php echo $nombre; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputRfc" class="col-sm-3 col-form-label" style="text-align: left;">R.F.C.:</label>
                        <div class="col-sm-9">
                          <input type="email" class="form-control" id="inputRfc" name="inputRfc" placeholder="Registro Federal de Contibuyentes"  value="<?php echo $rfccte; ?>">
                        </div>
                    </div>  

                    <div class="form-group row">
                        <label for="fformpa" class="col-sm-3 col-form-label" style="text-align: left;">Forma de Pago:</label>
                        <div class="col-sm-9">
                          <select name="fformpa" id="fformpa" required class="form-control custom-select" >
                              <option  value="<?php echo $formapago; ?>"><?php echo $formapago; ?></option>
                    ...
                    <div class="form-group row">
                        <label for="fmetd" class="col-sm-3 col-form-label" style="text-align: left;">Método de Pago:</label>
                        <div class="col-sm-9">
                          <select name="fmetd" id="fmetd" required class="form-control custom-select" >
                            <option value="<?php echo $metodopago; ?>"><?php echo $metodopago; ?></option>
                    ...
                    <div class="form-group row">
                        <label for="fusocfdi" class="col-sm-3 col-form-label" style="text-align: left;">Uso de CFDI:</label>
                        <div class="col-sm-9">
                          <select name="fusocfdi" id="fusocfdi" required class="form-control custom-select" >
                            <option value="<?php echo $usocfdi; ?>"><?php echo $usocfdi; ?></option>
                    ...
                    <div class="form-group row">
                        <label for="inputCcontabilidad" class="col-sm-3 col-form-label" style="text-align: left;">Contacto Contabilidad:</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="inputCcontabilidad" name="inputCcontabilidad" value="<?php echo $contacto_conta; ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="inputMailc" class="col-sm-3 col-form-label" style="text-align: left;">Correo Electrónico Contabilidad:</label>
                        <div class="col-sm-9">
                          <input type="email" class="form-control" id="inputMailc" name="inputMailc" value="<?php echo $correo_conta; ?>">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="fCredito" class="col-sm-3 col-form-label" style="text-align: left;">Credito:</label>
                        <div class="col-sm-3">
                        ...
                        <label for="fConcredito" class="col-sm-3 col-form-label" style="text-align: left;">Condiciones de Credito:</label>
                        <div class="col-sm-3">
                          <select name="fConcredito" id="fConcredito" required class="form-control custom-select" >
                            <option value="<?php echo $condicionesc; ?>"><?php echo $condicionesc; ?></option>
                      ...
                      <div class="form-group row">
                        <label for="inputStatus" class="col-sm-3 col-form-label" style="text-align: left;">Estatus:</label>
                        <div class="col-sm-9">
                          <select name="inputStatus" id="inputStatus" required class="form-control custom-select" >
                            <option value="<?php echo $estatus; ?>"><?php echo $estatuscte; ?></option>
