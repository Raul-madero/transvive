  ...
  <div class="content-wrapper">
    ...
    <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Solicitud de Credito</h3>
              </div>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                          <input type="number" step="any" class="form-control" id="inputMonto" name="inputMonto" value="0">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Plazo Solicitado:</label>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="inputPlazo" name="inputPlazo" >
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputRazonsoc" name="inputRazonsoc" placeholder="Nombre/Razón Social">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCalle" name="inputCalle" placeholder="Calle y Numero">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Entre las Calles:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputEntrecalle" name="inputEntrecalle" placeholder="Entre calle y calle" >
                        </div>
                      </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputSector" name="inputSector"  >
                        </div>
                      </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCpostal" name="inputCpostal" placeholder="Codigo Postal" value="0" >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="inputAntiguedad" name="inputAntiguedad" >
                        </div>
                      </div>
                  ...
                  <div class="tab-pane" id="timeline">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="inputNamerep" name="inputNamerep">
                        </div>
                        <label for="inputName" class="col-sm-1 col-form-label" style="text-align: left;">R.F.C.:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputRfcrep" name="inputRfcrep" placeholder="Registro Federal de Contribuyentes">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Calle:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCallerep" name="inputCallerep" placeholder="Calle y Numero">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Entre las Calles:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputEntrecallerep" name="inputEntrecallerep" placeholder="Entre Calle y la Calle">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Colonia:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputColoniarep" name="inputColoniarep">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Ciudad:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCiudadrep" name="inputCiudadrep">
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Estado:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputEstadorep" name="inputEstadorep">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Nacionalidad:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputNacionalidadrep" name="inputNacionalidadrep">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Correo:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCorreorep" name="inputCorreorep">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhonerep" name="inputPhonerep">
                        </div>
                    </div>
                  ...
                  <div class="post clearfix">
                    <form class="form-horizontal">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputBanco1" name="inputBanco1">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Sucursal:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputSucursal1" name="inputSucursal1">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputNocuenta1" name="inputNocuenta1">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhonebanco1" name="inputPhonebanco1">
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputEjecutivo1" name="inputEjecutivo1" placeholder="Nombre del Ejecutivo">
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;"><font color="#2371F4"> Banco:</font></label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputBanco2" name="inputBanco2">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Sucursal:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputSucursal2" name="inputSucursal2">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">No. de Cuenta:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputNocuenta2" name="inputNocuenta2">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhonebanco2" name="inputPhonebanco2">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Ejecutivo:</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputEjecutivo2" name="inputEjecutivo2" placeholder="Nombre del Ejecutivo">
                        </div>
                    </div>
                      ...
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;"><font color="#2371F4"> Banco:</font></label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputBanco3" name="inputBanco3">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Sucursal:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputSucursal3" name="inputSucursal3">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">No. de Cuenta:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputNocuenta3" name="inputNocuenta3">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhonebanco3" name="inputPhonebanco3">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Ejecutivo:</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputEjecutivo3" name="inputEjecutivo3" placeholder="Nombre del Ejecutivo">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputProveedor1" name="inputProveedor1">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhoneprov1" name="inputPhoneprov1">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Contacto:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputContactoprov1" name="inputContactoprov1">
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;"><font color="#19A367">Proveedor:</font></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputProveedor2" name="inputProveedor2">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhoneprov2" name="inputPhoneprov2">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Contacto:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputContactoprov2" name="inputContactoprov2">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;"><font color="#19A367">Proveedor:</font></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputProveedor3" name="inputProveedor3">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhoneprov3" name="inputPhoneprov3">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Contacto:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputContactoprov3" name="inputContactoprov3">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;"><font color="#19A367">Proveedor:</font></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputProveedor4" name="inputProveedor4">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhoneprov4" name="inputPhoneprov4">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Contacto:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputContactoprov4" name="inputContactoprov4">
                        </div>
                    </div>
                  ...
                  <div class="post clearfix">
                   ...
                   <div class="form-group row">
                      <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Nombre:</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="inputNameaval" name="inputNameaval" placeholder="Nombre del Aval">
                        </div>
                      <label for="inputName" class="col-sm-1 col-form-label" style="text-align: left;">R.F.C.:</label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="inputRfcaval" name="inputRfcaval" placeholder="Registro Federal de Contribuyentes">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Calle:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCalleaval" name="inputCalleaval" placeholder="Calle y Numero">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Entre las Calles:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputEntrecalleaval" name="inputEntrecalleaval" placeholder="Entre Calle y la Calle">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Colonia:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputColoniaaval" name="inputColoniaaval">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Ciudad:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCiudadaval" name="inputCiudadaval">
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Estado:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputEstadoaval" name="inputEstadoaval">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Sector:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputSectoraval" name="inputSectoraval">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputCpaval" name="inputCpaval" value="0">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Nacionalidad:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputNacionalidadaval" name="inputNacionalidadaval">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputEdocivilaval" name="inputEdocivilaval">
                        </div>
                        <label for="inputName" class="col-sm-2 col-form-label" style="text-align: left;">Teléfonos:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputPhoneaval" name="inputPhoneaval">
                        </div>
                    </div>
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputClienreref" name="inputClienreref">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputTiempocliente" name="inputTiempocliente">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputDiascredito" name="inputDiascredito">
                        </div>
                      </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputMontocredito" name="inputMontocredito">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputFormapago" name="inputFormapago">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputCualbanco" name="inputCualbanco">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputChequefondos" name="inputChequefondos">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputChequedevueltos" name="inputChequedevueltos">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputComprasmes" name="inputComprasmes">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputProductos" name="inputProductos">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputSaldopendiente" name="inputSaldopendiente">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputCantidadsaldo" name="inputCantidadsaldo">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputDiasatraso" name="inputDiasatraso">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputDomicilioref" name="inputDomicilioref">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputTerminos" name="inputTerminos">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-7" style="text-align:left;">
                          <input class="form-control" id="inputProporciona" name="inputProporciona">
                        </div>
                      </div>
        ...
        $.ajax({
                    ...
                    success: function(response)
                    {
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "SOLICITUD CREDITO ALMACENADO CORRECTAMENTE",
                          icon: 'success',
