<div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="index_almacen.php" class="nav-link">Home</a>
          </li>
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li><a href="#" class="dropdown-item">Cotizacion al Cliente</a></li>
                </ul>
              </li>
               -->
               <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li class="dropdown-divider"></li>
                  <li><a href="pagos.php" class="dropdown-item">Pago a Proveedor</a></li>
                  <li class="dropdown-divider"></li>
              ...
              <li class="dropdown-submenu dropdown-hover">
               ...
               <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li><a href="#" class="dropdown-item">Entrada</a></li>
                  <li><a href="#" class="dropdown-item">Salida</a></li>
            ...
            <!--
               <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li><a href="factura/detallado_encsatisfaccion.php" target="_blank" class="dropdown-item">Detallado Encuesta Satisfacción</a></li>
              ...
              <!--
              <li class="dropdown-submenu dropdown-hover">
                <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Viajes Especiales</a>
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  
                  <li><a href="viajes_especialesxfechas.php" class="dropdown-item">Viajes por Fecha</a></li>

                  <li><a href="viajes_especialesxperiodos.php" class="dropdown-item">Viajes por Periodo</a></li>
