...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (isset($_GET['id'])) {      
      ...
      $sql = $conexion->prepare("SELECT cliente, fecha, if(servicio_ventas = 'Excelente',3,if(servicio_ventas = 'Bueno', 2, if (servicio_ventas = 'Regular', 2, if(servicio_ventas = 'Malo', 0,0)))) as sventas FROM newencuesta_clientes WHERE YEAR(fecha) = YEAR(CURDATE()) GROUP by cliente");
      $sql->execute();
