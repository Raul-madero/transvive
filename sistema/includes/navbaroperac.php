<div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="index_rhumanos.php" class="nav-link">Home</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <li class="dropdown-divider"></li>
               <li><a href="viajes_especiales.php" class="dropdown-item">Asignación de Servicios Especiales</a></li>  
              ...
              <li><a href="#" class="dropdown-item">Servicios</a></li>-->
               <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li><a href="#" class="dropdown-item">Concentrado</a></li>
                  <li><a href="reprecibos_nomina.php" class="dropdown-item">Recibo de Nomina</a></li>
                  <li><a href="supervisores.php" class="dropdown-item">Detallado</a></li>
