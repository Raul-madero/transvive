<div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="index_monitorista.php" class="nav-link">Home</a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <!--<li><a href="solicitud_mantto.php" class="dropdown-item">Orden de Trabajo de Mantenimiento</a></li>-->
          ...
          -->
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="encuesta_calidad.php" class="dropdown-item">Calidad </a></li>-->
