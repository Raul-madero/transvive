...
if ($_POST['action'] == 'AlmacenaRuta') {
    if (!empty($_POST['cliente']) && !empty($_POST['ruta'])) {
        ...
        $horario1   = mysqli_real_escape_string($conection, trim($_POST['horario1']))?? NULL;
        $horario2   = mysqli_real_escape_string($conection, trim($_POST['horario2'])) ?? NULL;
        $horario3   = mysqli_real_escape_string($conection, trim($_POST['horario3'])) ?? NULL;
        $hmixto1    = mysqli_real_escape_string($conection, trim($_POST['hmixto1'])) ?? NULL;
        $hmixto2    = mysqli_real_escape_string($conection, trim($_POST['hmixto2'])) ?? NULL;
