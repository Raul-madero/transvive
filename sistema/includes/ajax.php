...
if ($_POST['action'] == 'AlmacenaRuta') {
    if (!empty($_POST['cliente']) && !empty($_POST['ruta'])) {
        ...
        $horario1   = mysqli_real_escape_string($conection, trim($_POST['horario1']))?? '00:00:00';
        $horario2   = mysqli_real_escape_string($conection, trim($_POST['horario2'])) ?? '00:00:00';
        $horario3   = mysqli_real_escape_string($conection, trim($_POST['horario3'])) ?? '00:00:00';
        $hmixto1    = mysqli_real_escape_string($conection, trim($_POST['hmixto1'])) ?? '00:00:00';
        $hmixto2    = mysqli_real_escape_string($conection, trim($_POST['hmixto2'])) ?? '00:00:00';
