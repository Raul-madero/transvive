...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
    if (isset($_GET['id'])) {      
      ...
      $sql = $conexion->prepare("SELECT cliente, fecha, tiempo_forma, tiempo_respuesta, disponibilidad, calidad, asesoria_tecnica, limpieza_condicion, servicio_operador, conduce_adecuado, atencion_calidad, servicio_facturacion, nuestros_precios FROM newencuesta_clientes WHERE YEAR(fecha) = YEAR(CURDATE()) GROUP by cliente");
      $sql->execute();
