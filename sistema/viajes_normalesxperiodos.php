  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte de Viajes Normales por Periodo</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/viajesnormales_xperiodoexcel.php?id='+ document.getElementById('inputSemana').value + 'id2='+document.getElementById('inputMes').value + 'id3='+document.getElementById('inputEjercicio').value );" >
