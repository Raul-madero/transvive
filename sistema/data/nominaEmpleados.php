...
if (isset($_POST['semana'], $_POST['anio']) && !empty($_POST['semana']) && !empty($_POST['anio'])) {
    ...
    $total_efectivo = $conection->query("SELECT SUM(sueldo_bruto+ bono_semanal + bono_supervisor + bono_categoria + apoyo_mes + pago_vacaciones + prima_vacacional +sueldo_adicional - deducciones - caja_ahorro) AS total_efectivo FROM nomina_temp_2025")->fetch_assoc();
