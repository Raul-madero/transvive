...
if (isset($_POST['semana'], $_POST['anio']) && !empty($_POST['semana']) && !empty($_POST['anio'])) {
    ...
    $total_nomina = $conection->query("SELECT SUM((sueldo_bruto - nomina_fiscal) + bono_semanal + bono_supervisor + bono_supervisor + bono_categoria + apoyo_mes + pago_vacaciones + sueldo_adicional + prima_vacacional - deducciones - caja_ahorro) AS total_nomina FROM nomina_temp_2025")->fetch_assoc();
