            ...
            CASE 
                ...
                ELSE
                    CASE
                        ...
                        WHEN LOWER(rv.unidad_ejecuta) REGEXP '\\jac\\b' AND IFNULL(r.sueldo_camioneta, 0) > 0 THEN GREATEST(r.sueldo_camioneta, e.sueldo_camioneta) * rv.valor_vuelta
                        ...
                        WHEN LOWER(rv.unidad_ejecuta) LIKE '%jac%' THEN e.sueldo_camioneta * rv.valor_vuelta
