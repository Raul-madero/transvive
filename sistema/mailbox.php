              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <!--<tr>
                    ...
                    <?php
                    // Recorre los correos electrónicos y muéstralos en la tabla
      foreach($emails as $email_number) {
        $overview = imap_fetch_overview($inbox, $email_number, 0);
        $subject = imap_utf8($overview[0]->subject); //Convierte a UTF-8
        $from = $overview[0]->from;
        $date = date("d-m-Y H:i:s", strtotime($overview[0]->date));
        echo "<tr>";
        echo "<td>";
        echo "<div class='icheck-primary'>";
        echo "<input type='checkbox' value='' id='check1'>";
        echo "</div>";
        echo "</td>";
        echo "<td class='mailbox-name'><a href='read-mail.html'>".$from."</td>";
        echo "<td>".$subject."</td>";
        echo "<td>".$date."</td>";
        echo "</tr>";
      }
