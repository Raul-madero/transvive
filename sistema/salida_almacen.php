  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Salidas de Almacén</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_salidaalmacen.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
...
"bProcessing": true,
"sAjaxSource": "data/data_salidaalmacen.php",
"bPaginate":true,
...
"aoColumns": [
{ mData: 'id', 'sWidth': "5%"} ,
{ mData: 'Datereg', 'sWidth': "20%"},
{ mData: 'serie', 'sWidth': "15%"},
{ mData: 'folio', 'sWidth': "15%"},
{ mData: 'cantidad_total', 'sWidth': "8%"},
{ mData: 'Status', 'sWidth': "10%"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_salida.php?id=' + full.folio +  '\'><i class="far fa-edit"></i> Editar</a> | <a href= \'factura/salidaalmacen.php?id=' + full.id + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> Print</a> | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-name=\'' + full.folio +  '\' data-serie=\'' + full.serie +  '\'  href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> ';
    }
...
<script> 
  ...
  $('#modalEditcliente').on('show.bs.modal', function(e) { 
     ...
     var no_serie  = $(e.relatedTarget).data().serie;
     var no_orden  = $(e.relatedTarget).data().name;
  
     
    
      $(e.currentTarget).find('#form_pass_idc').val(idi);
      $(e.currentTarget).find('#form_pass_serie').val(no_serie);
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Cancelar Salida</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-4 col-form-label" style="text-align: left;">Serie:</label>
           <div class="col-sm-8">
              <input type="text" class="form-control" id="form_pass_serie" name="form_pass_serie" readonly>
           </div>
        </div>  

        <div class="form-group row">
           <label for="inputName2" class="col-sm-4 col-form-label" style="text-align: left;">Folio:</label>
           <div class="col-sm-8">
              <input type="text" class="form-control" id="form_pass_noorden" name="form_pass_noorden" readonly>
           </div>
        </div>  
    
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-success pull-right" href="#" id="actualizaclientes"><i class="fa fa-save"></i>&nbsp;Cancelar</button>
      </div>
      </form>
    </div>
  </div>
...
<script>
   $('#actualizaclientes').click(function(e){
        ...
        var noserie      = $('#form_pass_serie').val();
        var noorden      = $('#form_pass_noorden').val();

       var action       = 'BajaSalida';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, idc:idc, noserie:noserie, noorden:noorden},
