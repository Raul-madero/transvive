                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <form class="form-horizontal">
                                ...
                                <label for="inputMotivo" class="col-sm-2 col-form-label" style="text-align: left;">Motivo:</label>
                                    <div class="col-sm-10" style="text-align:left;">
                                        <select class="form-control select2bs4" style="width: 100%; text-align: left" id="inputMotivo" name="inputMotivo">
                                            ...
                                            <option value="<?php echo $ops['id'] ?>"> <?=  $ops['motivo_adeudo'] ?> </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <textarea class="form-control w-100" id="inputComentarios" name="inputComentarios"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="text-align:right;">
                                    <div class="offset-sm-2 col-sm-10">
                                        ...
                                        <button type="submit" class="btn btn-success" id="guardar_adeudo">Guardar</button>
                                    </div>
                                </div>
                            </form>
                  </div>  
