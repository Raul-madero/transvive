  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
          <h4 class="m-0"> Listado de Evaluación de Proveedores <small><i class="fas fa-check-circle"></i></small></h4>
          </div>
          ...
          <ol class="breadcrumb float-sm-right">
            <?php
             ...
             ?> 
               <li class="breadcrumb-item"><a href="new_evaluacionprov.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
