...
{ mData: 'cliente' ,"sWidth": "200px"},
{ mData: 'ruta' ,"sWidth": "200px"},
{ mData: 'tipo_viaje' ,"sWidth": "100px"},
{ mData: 'Status' ,"sWidth": "100px"},
{ mData: 'id' ,"sWidth": "200px"}
   ...
   $('#actualizafinviaje').click(function(e){
       ...
       var action       = 'FindeViaje';
        ...
        $.ajax({
                    ...
                    type: "POST",
                    async : true,
                    data: {action:action, idf:idf, fecha_fin:fecha_fin, hora_fin:hora_fin, ubicacionfin:ubicacionfin},
