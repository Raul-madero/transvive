  ...
  <div class="content-wrapper">
    ...
    <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Registro de Prestamo</h3>
              </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="col-sm-5">
                      <input type="number" class="form-control" id="inputMonto" name="inputMonto" min="1" required>
...
<script>
   $('#guardar_Cliente').click(function(e){
       ...
       var action       = 'AlmacenaPrestamo';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, fecha:fecha, noempleado:noempleado, empleado:empleado, monto:monto, descripcion:descripcion},
                    ...
                    success: function(response)
                    {
                       if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "PRESTAMO ALMACENADO CORRECTAMENTE",
                          icon: 'success',
