  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte Detallado de Nomina</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                          ...
                          <div class="col-3">
                            ...
                            <div class="col-3">
                                 <div class="form-group">
                                   ...
                                   <select id="semana2" name="semana2" class="form-control select2bs4" disabled=""></select>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                      ...
                      <div class="col-3">
                      <a href="#" onclick="window.open ('factura/repdetallado_nomina.php?id='+ document.getElementById('inputTiponomina').value + 'id2='+document.getElementById('semana').value + 'id3='+document.getElementById('semana2').value + 'id4='+document.getElementById('inputEjercicio').value );" >  
