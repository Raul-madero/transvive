...
session_start();
  ...
  {
    header('Location: nominas_quincenales.php');
...
<script>
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" id="form_pass_nosem" name="form_pass_nosem" >
 ...
 <script>
   $('#actualizaclientes').click(function(e){
        ...
        //var semana = document.getElementById("semana").value;
         ...
         var action     = 'DeleteEmpleadoNomQuinEdit';
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row" hidden>
           <label for="inputName2" class="col-sm-4 col-form-label" style="text-align: left;">Quincena:</label>
           <div class="col-sm-8">
 ...
 <script>
   $('#actualizaNomempleado').click(function(e){
        ...
        var action     = 'ActualizaNomEmpleadoQuincenaEdit';
...
"order": [[ 1, "asc" ]],     
"bProcessing": true,
"sAjaxSource": "data/data_editnominaquincenal.php?id=<?php echo $idnom; ?>",
"data": { Id: Id },
"bPaginate":true,
