  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Requisiciones</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
"bProcessing": true,
"sAjaxSource": "data/data_cotizacioncompra.php",
"bPaginate":true,
...
"aoColumns": [
{ mData: 'id', 'sWidth': "5%"} ,
{ mData: 'no_requisicion', 'sWidth': "10%"},
{ mData: 'Datereg', 'sWidth': "10%"},
{ mData: 'Datereq', 'sWidth': "12%"},
{ mData: 'tipo_requisicion', 'sWidth': "8%"},
{ mData: 'area_solicitante', 'sWidth': "25%"},
{ mData: 'Status', 'sWidth': "10%"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'#.php?id=' + full.id +  '\'><i class="far fa-edit"></i> Editar</a> | <a href= \'factura/requisicion.php?id=' + full.no_requisicion + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> Print</a><!-- | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-name=\'' + full.no_orden +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> -->';
    }
