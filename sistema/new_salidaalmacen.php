    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Salida de Almacén</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-2">
                      <input style="text-align:right; color: #FE3911; font-weight: bold" type="text" class="form-control" id="inputFolio" name="inputFolio" value="<?php echo $nuevofolio;?>" readonly>
                    </div>
                  </div>
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "SALIDA DE ALMACEN ALMACENADA CORRECTAMENTE",
                          icon: 'success',
...
<script>
   $('#actualizaclientes').click(function(e){
       ...
       var action       = 'AddDetalleSalidaalm';
