...
// Create the chart
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'No conformidades por Mes por Responsable (EXTERNO)',
        align: 'left'
    },
    subtitle: {
        text:
    ...
    xAxis: {
        categories: ['<?php echo join($responsable, "','") ?>'],
        crosshair: true,
        accessibility: {
