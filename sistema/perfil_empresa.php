...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT id, razon_social, regfed, correo, telefono, callenum, codpostal, colonia, ciudad, estado FROM perfil_empresa WHERE id = 1");
  ...
  $result_sqlact = mysqli_num_rows($sqlact);
    ...
    while ($data = mysqli_fetch_array($sqlact)){
      $id       = $data['id'];
      $razonsoc = $data['razon_social'];
      $rfc      = $data['regfed'];
      $correo   = $data['correo'];
      $phone    = $data['telefono'];
      $callenum = $data['callenum'];
      $codpost  = $data['codpostal'];
     ...
     <div class="card card-secondary">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNombre" name="inputNombre" placeholder="Razon Social" value="<?php echo $razonsoc; ?>">
                    </div>
                  </div>

                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">R.F.C.</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputRfc" name="inputRfc" placeholder="Registro Federal de Contibuyntes" value="<?php echo $rfc; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputMail" name="inputMail" value="<?php echo $correo; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Telefono</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputTelefono" name="inputTelefono" value="<?php echo $phone; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputCalle" name="inputCalle" placeholder="Calle y numero" value="<?php echo $callenum; ?>">
                    </div>
                  </div>

                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Codigo Postal</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputCp" name="inputCp" value="<?php echo $codpost; ?>">
                    </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var idemp    = $('#inputId').val();
       var nombre    = $('#inputNombre').val();
       var regfc     = $('#inputRfc').val();
       var mail      = $('#inputMail').val();
       var phone     = $('#inputTelefono').val();
       var callenum  = $('#inputCalle').val();
       var codpostal = $('#inputCp').val();
       var colonia   = $('#inputColonia').val();
       var city      = $('#inputCiudad').val();
       var estado    = $('#inputEstado').val();

       var action       = 'AlmacenaPerfilempresa';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, idemp:idemp, nombre:nombre, regfc:regfc, mail:mail, phone:phone, callenum:callenum, codpostal:codpostal, colonia:colonia, city:city, estado:estado },
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "PERFIL DE EMPRESA ALMACENADO CORRECTAMENTE",
                          icon: 'success',
