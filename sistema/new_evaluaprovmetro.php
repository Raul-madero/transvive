...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaEvaluametro';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, tipo_eval, fecha:fecha, proveedor:proveedor, producto:producto, consulta:consulta, fecha_h1:fecha_h1, historial_h1:historial_h1, fecha_h2:fecha_h2, historial_h2:historial_h2, fecha_h3:fecha_h3, historial_h3:historial_h3, tot_compras:tot_compras, tot_calidad:tot_calidad, calif_total:calif_total, estatusc:estatusc, acciones:acciones, precios:precios, documenta:documenta, credito:credito },
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "EVALUACION DE METROLOGÍA ALMACENADA CORRECTAMENTE",
                          icon: 'success',
                       ...
                       if (resultado.value) {
                        ...
                        location.href = 'evalua_provemetrologia.php';
                          ...
                          // Dijeron que no
                          location.reload();
                         location.href = 'evalua_provepetrologia.php';
                        }
                        });
