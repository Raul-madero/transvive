...
session_start();
  ...
  $sqlact= mysqli_query($conection,"SELECT ac.id, ac.titulo, ac.ingreso_estimado, ac.probabilidad,
   ac.cliente, ac.cierre_previsto, ac.categoria, ac.estado, ac.notas, ct.nombre FROM actividades ac
   INNER JOIN clientes ct ON ac.cliente = ct.id WHERE ac.id=$idact");
  mysqli_close($conection);
  ...
  if($result_sqlact == 0){
    ...
    while ($data = mysqli_fetch_array($sqlact)){
      ...
      $cierre       = $data['cierre_previsto'];
      $categoria    = $data['categoria'];
      $estado       = $data['estado'];
      $notas        = $data['notas'];
      $name_cliente = $data['nombre'];
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edición de Mi Nueva Actividad</h3>
              </div>
              <div class="card-body">
              ...
              <input type="hidden" id="id_act" name="id_act" value="<?php echo $id; ?>">
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputTitulo" name="inputTitulo" placeholder="Ejemplo: Lista de Precios" value="<?php echo $titulo; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="inputIngreso" name="inputIngreso" value="<?php echo $ingreso; ?>">
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">% Probabilidad</label>
                    <div class="col-sm-4" style="text-align:left;">
                    <input type="number" class="form-control" id="inputProbabilidad" name="inputProbabilidad" value="<?php echo $probabilidad; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <select class="form-control select2bs4" style="width: 100%; text-align: left" id="inputCliente" name="inputCliente">
                       <option value="<?php echo $cliente; ?>"><?php echo $name_cliente; ?></option>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="inputCierre" name="inputCierre" placeholder="Ejemplo: Lista de Precios" value="<?php echo $cierre; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                    <textarea class="form-control" rows="2" id="inputNotas" name="unputNotas" placeholder="Notas de la Actividad">
                    <?php echo $notas; ?>
                    </textarea>
                    </div>
                  </div>
...
<script>
   $('#guardar_miactividad').click(function(e){
       ...
       var action       = 'AlmacenaEditMiActividad';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, id_act:id_act, titulo:titulo, ingreso:ingreso, probabilidad:probabilidad,
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "MI ACTIVIDAD EDITADA CORRECTAMENTE",
                          icon: 'success',
