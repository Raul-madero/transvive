  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte de Rendimiento por Unidad</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                            <div class="col-8">
                              <!--
                                <div class="form-group">
                                    <label>Unidad:</label>
                                    <select class="form-control" style="width: 100%; text-align: left" id="inputunidadini" name="inputunidadini">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 100%; text-align: left" id="inputunidadfin" name="inputunidadfin">
                                    <option value="">- Seleccione -</option>
                                    <?php foreach ($filasunid as $opun): //llenar las opciones del primer select ?>
                                    <option value="<?= $opun['no_unidad'] ?>"><?= $opun['no_unidad'] ?></option>  
                                    <?php endforeach; ?>
                       ...
                       <!-- 
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/combustible_rendimiento.php?id='+ document.getElementById('inputunidadini').value );" >
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/rendimiento_unidadexcel2.php?id='+ document.getElementById('inputunidadini').value );" >
                    ...
                    -->
                       <div class="col-2">
                      <a href="#" onclick="window.open ('factura/rendimiento_unidadexcel.php' );" >
                       
                          <button type ="button" class="btn btn-success pull-left"><i class="fa fa-file-excel"></i> TODAS</button>
                        </a>
                      </div>
                      ...
                      ?>    
                          <div class="col-2">
                      <a href="#" onclick="window.location ='index_almacen.php';" >
                      ...
                      ?>
                    <div class="col-2">
                      <a href="#" onclick="window.location ='carga_combustible23.php';" >
                        <button type ="button" class="btn btn-secondary pull-left" href="#"><i class="fa fa-stop"></i> Cancelar</button>
                    </div>
                    <?php
                      }
