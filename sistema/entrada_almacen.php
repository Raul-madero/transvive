  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Entradas de Almacén</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_entradaalmacen.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nueva</a></li>
...
"bProcessing": true,
"sAjaxSource": "data/data_entradaalmacen.php",
"bPaginate":true,
...
{ mData: 'Status', 'sWidth': "10%"},
{
        ...
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_entradaalmacen.php?id=' + full.folio +  '\'><i class="far fa-edit"></i> Editar</a> | <a href= \'factura/entradaalmacen.php?id=' + full.id + '\'  target="_blank"><i class="fa fa-print" style="color:#white; font-size: 1.3em"></i> Print</a> | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-name=\'' + full.folio +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="fa fa-ban"></i> Cancelar</a> ';
    }
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Cancelar Entrada</h5>
      </div>
