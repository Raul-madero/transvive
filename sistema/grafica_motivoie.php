...
// Create the chart
  ...
  Highcharts.chart('container', {
    ...
    title: {
        text: 'No conformidades por Mes (MOTIVO INTERNO/EXTERNO)',
        align: 'left'
    },
    subtitle: {
        text:
    ...
    xAxis: {
        categories: ['<?php echo join($incidente, "','") ?>'],
        crosshair: true,
        accessibility: {
            description: 'Motivo incidente'
        }
    },
    yAxis: {
        min: 0,
