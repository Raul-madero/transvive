    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta Almacen</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNamealmacen" name="inputNamealmacen" placeholder="Nombre del Almacen">
                    </div>
                  </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaAlmacen';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, codigo:codigo, namealmacen:namealmacen},
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "ALMACEN ALMACENADO CORRECTAMENTE",
                          icon: 'success',
