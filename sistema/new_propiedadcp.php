    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Propiedad del Cliente Proveedor</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  -->
                    ...
                    <div class="form-group row" style="text-align:left;">
                     <label for="inputEmail3" class="col-sm-5 col-form-label">Empresa que Resguarda</label>
                    <div class="col-sm-7">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="inputRepresentante" name="inputRepresentante" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputTelefonos" name="inputTelefonos">
                    </div>
                 ...
                 <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputBien" name="inputBien">
                    </div>              
                  </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" id="inputCaracteristicas" name="inputCaracteristicas" rows="1"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" id="inputUtilizarse" name="inputUtilizarse" rows="1"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" id="inputIdentificacion" name="inputIdentificacion" rows="1"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" id="inputVerificacion" name="inputVerificacion" rows="1"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" id="inputProteccion" name="inputProteccion" rows="1"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" id="inputSalvaguarda" name="inputSalvaguarda" rows="1"></textarea>
                    </div>
                  </div>
                    
                  <p><b>Acciones de contingencia</b></p>

                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nombre:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputNombre1" name="inputNombre1">
                    </div>
                   </div> 
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputPuesto1" name="inputPuesto1">
                    </div>


                     <label for="inputEmail3" class="col-sm-2 col-form-label">Telefono y Correo:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputTelcorreo1" name="inputTelcorreo1" >
                    </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Puesto:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputPuesto2" name="inputPuesto2">
                    </div>


                     <label for="inputEmail3" class="col-sm-2 col-form-label">Telefono y Correo:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputTelcorreo2" name="inputTelcorreo2" >
                    </div>
                    ...
                    <div class="col-sm-4">
                      <input class="form-control" id="inputEmpresarecibe" name="inputEmpresarecibe">
                    </div>
                     <label for="inputEmail3" class="col-sm-2 col-form-label">Empresa que entrega:</label>
                    <div class="col-sm-4">
                      <input class="form-control" id="inputEmpresaentrega" name="inputEmpresaentrega">
                    </div>
                  </div>
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "PROPIEDAD DEL CLIENTE O PROVEEDOR ALMACENADA CORRECTAMENTE",
                          icon: 'success',
