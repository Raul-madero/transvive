...
$query = mysqli_query($conection,"SELECT * FROM salida_almacen WHERE id = $nosal");
...
//Variables para encabezado
    ...
    //$contenido = 'Certificado '.$certificado.' Almacen '.$almacen;
       ...
       $subtitulo1=utf8_decode('SALIDA DE ALMACEN');
...
$this->Cell(30,10,'FO-TV-00-02',1,1,'C');
$this->SetFont('Arial','',10);
...
$query00 = mysqli_query($conection,"SELECT serie, folio FROM salida_almacen WHERE id = $nosal");
...
$query = mysqli_query($conection,"SELECT * FROM salida_almacen WHERE serie = '$serie' and folio = $folio");
$result = mysqli_num_rows($query);
$entrada = mysqli_fetch_assoc($query);
//$encabezado = mysql_fetch_array($query1, $conexion);
//Variables para encabezado
...
$queryr = mysqli_query($conection,"SELECT * FROM detalle_salidaalm WHERE serie = '$serie' and folio = $folio");
