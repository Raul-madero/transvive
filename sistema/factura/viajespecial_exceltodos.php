<?php
   ...
   header("Content-type: application/vnd.ms-excel");
    header("Content-Disposition: attachment; filename= Viajes Especiales Todos.xls");
    ...
    //...
      ...
      ?>
        <tr>
          ...
          <td><?php echo strtoupper($ndest); ?></td>
