    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Cotización Venta</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputAtencion" name="inputAtencion">
                    </div>
                  </div>
                  ...
                  <div id="esprospecto" class="form-group row" style="text-align:left;" hidden>
                  ...
                  <div id="escliente" class="form-group row" style="text-align:left;" hidden>
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Empresa</label>
                    <div class="col-sm-10">
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputDiascomienzo" name="inputDiascomienzo">
                    </div>
                   ...
                   <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputFechaini" name="inputFechaini">
                    </div>


                     <label for="inputEmail3" class="col-sm-2 col-form-label">Hasta</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputFechafin" name="inputFechafin">
                    </div>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var action       = 'AlmacenaCotizacionvta';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, folio:folio, fecha:fecha, atencion:atencion, tcliente:tcliente, name_empresa:name_empresa, direccion:direccion, diascredito:diascredito, diascomienzo:diascomienzo, dateinicio:dateinicio, datefin:datefin, notas:notas},
...
<script>
   $('#actualizaclientes').click(function(e){
        ...
        var action       = 'AddDetallecotizacionventa';
    ...
    var action = 'delDeattecotizacionventa';
    var id_det = id;
    var folio_det = folio;
...
<script>
   $('#actualiza_paradar').click(function(e){
        ...
        var action       = 'ActualizaMovcotizacionventa';
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form id="uploadForm" action="subir-imagencot.php" method="post" enctype="multipart/form-data" target="uploadFrame">
