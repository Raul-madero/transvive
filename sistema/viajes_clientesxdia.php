  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte de viajes por Cliente por día</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    <label>Dia:</label>
                                    <input style="text-align:right;" name="inputFechaini" id="inputFechaini" type="date" class="form-control" value="<?php echo $fcha;?>">
                                </div>
                            </div>
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/viajes_clientesdia.php?id='+ document.getElementById('inputFechaini').value );" >
