  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Mis Actividades</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
"bProcessing": true,
"sAjaxSource": "data/data_misactividades.php",
"bPaginate":true,
...
"aoColumns": [
{ mData: 'id', "sWidth": "5%" } ,
{ mData: 'titulo' ,"sWidth": "30%"},
{ mData: 'nombre' ,"sWidth": "30%"},
{ mData: 'Status' ,"sWidth": "10%"},
{ mData: 'Cierre' ,"sWidth": "10%"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_miactividad.php?id=' + full.id +  '\'><i class="far fa-edit"></i> Editar</a> | <a id="delete_cliente" data-id=\'' + full.id +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="far fa-trash-alt"></i> Borrar</a>';
    }
