  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Reporte de Viajes Especiales por Periodo</h2>
                    ...
                    <div class="col-md-10 offset-md-1">
                      ...
                      <option value="Semana 53">Semana 53</option>
                          ...
                          <div class="col-4">
                                <div class="form-group">
                                    <label>Mes:</label>
                                    <select class="form-control select2bs4" style="width: 100%; text-align: left" id="inputMes" name="inputMes">
                      ...
                      <div class="col-2">
                      <a href="#" onclick="window.open ('factura/viajesespeciales_xperiodoexcel.php?id='+ document.getElementById('inputSemana').value + 'id2='+document.getElementById('inputMes').value + 'id3='+document.getElementById('inputEjercicio').value );" >
                       
                          <button type ="button" class="btn btn-success pull-left"><i class="fa fa-file-excel"></i> Excel</button>
                        </a>
                      </div>
                    <div class="col-2">
                      <a href="#" onclick="window.location ='viajes_especiales.php';" >
