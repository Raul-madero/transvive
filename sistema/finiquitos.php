  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Finiquitos</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_finiquitos.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nuevo</a></li>
...
"bProcessing": true,
"sAjaxSource": "data/data_finiquitos.php",
"bPaginate":true,
...
{ mData: 'fecha' ,"sWidth": "50px"},
{ mData: 'no_empleado' ,"sWidth": "100px"},
{ mData: 'empleado' ,"sWidth": "400px"},
{ mData: 'fecha_ingreso' ,"sWidth": "100px"},
{ mData: 'fecha_baja' ,"sWidth": "80px"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_finiquito.php?id=' + full.id +  '\' ><i class="fa fa-edit"></i> </a> | <a href= \'factura/finiquito.php?id=' + full.id + '\'  target="_blank" ><i class="fa fa-eye" style="color:#54AEB6;  font-size: 1.2em"></i></a> | <a data-toggle="modal" data-target="#modalEditcliente"  data-id=\'' + full.id +  '\' data-noemp=\'' + full.no_empleado  +  '\' data-name=\'' + full.empleado +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="far fa-trash-alt"></i> Baja</a>';
    }
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Borra finiquito de:</h5>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group row">
           <label for="inputName2" class="col-sm-4 col-form-label" style="text-align: left;">No Empleado:</label>
           <div class="col-sm-8">
   ...
   $('#actualizaclientes').click(function(e){
        ...
        $.ajax({
                    ...
                    //console.log(response);
                       if(response != 'error')
                      {
                        swal('Eliminado','Finiquito Borrado','success').then((value) => {
                            ...
                            console.log('no data');
                            swal('Error','Finiquito no se puede borrar','warning').then((value) => {
