  ...
  <div class="content-wrapper">
   <section class="content">
        <div class="container-fluid">
            <h2 class="text-center">Viajes Planeados vs Registrados</h2>
            <form action="enhanced-results.html">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="row">
                          <div class="col-3">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <label>Periodo:</label>
                                   <select id="inputNosemana" name="inputNosemana" class="form-control select2bs4" disabled=""></select>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                      ...
                      <div class="col-3">
                      <a href="#" onclick="window.open ('factura/rep_planeadosvsreg.php?id='+document.getElementById('inputNosemana').value + 'id3='+document.getElementById('inputEjercicio').value ) ;" >
                      ...
                      <?php
                       ...
                       ?>
                    <div class="col-3">
                      <a href="#" onclick="window.location ='index_rhumanos.php';" >
