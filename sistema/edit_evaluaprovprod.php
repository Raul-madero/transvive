...
//Mostrar Datos
  ...
  {
    header('Location: evalua_proveproductos.php');
    mysqli_close($conection);
  }
  $noeval = $_REQUEST['id'];

  $sqlact= mysqli_query($conection,"SELECT * FROM evaluaciones_productos WHERE ideval = $noeval");
  mysqli_close($conection);
  ...
  if($result_sqlact == 0){
    ...
    while ($data = mysqli_fetch_array($sqlact)){
      ...
      $respuestaem    = $data['respuesta_emergencias'];
      $servicio       = $data['servicio_domicilio'];  
      $empaque        = $data['condicion_empaque'];
      $rechazo        = $data['rechazos'];
     ...
     <div class="card card-secondary">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-9">
                      <input class="form-control" id="inputProducto" name="inputProducto" value="<?php echo $producto;?>">
...
<tr>
  ...
  <td>DOCUMENTACIÓN</td>
  <td>1 - 30</td>
  <td><input type="number" id="input1" name="input1" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $documenta;?>" <?php echo $activo;?>></td>
</tr>
<tr>
  <td>2. </td>
  <td>COMPRAS</td>
  <td>CRÉDITO</td>
  <td>1 - 15</td>
  <td><input type="number" id="input2" name="input2" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $credito;?>" <?php echo $activo;?>></td>
</tr>
<tr>
  <td>3. </td>
  <td>COMPRAS</td>
  ...
  <td>1 - 35</td>
  <td><input type="number" id="input3" name="input3" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $precios;?>" <?php echo $activo;?>></td>
</tr>
<tr>
  <td>4. </td>
  <td>COMPRAS</td>
  ...
  <td>1 - 20</td>
  <td><input type="number" id="input4" name="input4" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $servicio;?>" <?php echo $activo;?>></td>
</tr>
...
<tr>
  ...
  <td>1 - 25</td>
  <td><input type="number" id="input5" name="input5" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $tiempo_resp;?>" <?php echo $activo;?>></td>
</tr>
<tr>
  <td>2. </td>
  <td>COMPRAS</td>
...
<tr>
  ...
  <td>PRECIO COMPETITIVO</td>
  <td>1 - 30</td>
  <td><input type="number" id="input8" name="input8" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $precios;?>" <?php echo $activo;?>></td>
</tr>

<tr>
  <td>5. </td>
  <td>COMPRAS</td>
  <td>RESPUESTA A EMERGENCIAS</td>
  <td>1 - 20</td>
  <td><input type="number" id="input9" name="input9" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $respuestaem;?>" <?php echo $activo;?>></td>
</tr>
...
<tr>
  ...
  <td>SERVICIO A DOMICILIO</td>
  <td>1 - 10</td>
  <td><input type="number" id="input10" name="input10" min="0" step="1" oninput="validateInput(this)" onblur="updateSum()" value="<?php echo $servicio;?>" <?php echo $activo;?>></td>
</tr>
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var empaque       = $('#input11').val();
       var rechazo       = $('#input12').val();
       var identifica    = $('#input13').val();

       if (tipo_eval == 'SELECCIÓN') {
        var tiempo_res = 0;
        var documenta  = $('#input1').val();
        var credito    = $('#input2').val();
        var precios    = $('#input3').val();
        var emergencia = 0;
        var servicios  = $('#input4').val();
       }else {
        var tiempo_res = $('#input5').val();
        var documenta  = $('#input6').val();
        var credito    = $('#input7').val();
        var precios    = $('#input8').val();
        var emergencia = $('#input9').val();
        var servicios  = $('#input10').val();
       }
   
     
       var action       = 'AlmacenaEditEvaluaproducto';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, id_eval:id_eval, tipo_eval, fecha:fecha, proveedor:proveedor, producto:producto, consulta:consulta, fecha_h1:fecha_h1, historial_h1:historial_h1, fecha_h2:fecha_h2, historial_h2:historial_h2, fecha_h3:fecha_h3, historial_h3:historial_h3, tot_compras:tot_compras, tot_calidad:tot_calidad, calif_total:calif_total, estatusc:estatusc, acciones:acciones, tiempo_res:tiempo_res, documenta:documenta, credito:credito, precios:precios, emergencia:emergencia, servicios:servicios, empaque:empaque, rechazo:rechazo, identifica:identifica },
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "EVALUACION DE PRODUCTO EDITADA CORRECTAMENTE",
                          icon: 'success',
...
-->
  ...
  <script>
    ...
    function updateSum() {
     ...
     // alert('Function called'); // Verifica si esta alerta aparece
      ...
      var input10 = parseFloat($('#input10').val());
      var input11 = parseFloat($('#input11').val());
      var input12 = parseFloat($('#input12').val());
      var input13 = parseFloat($('#input13').val());
    ...
    */
      ...
      var sum =  input5 + input6 + input7 + input8 + input9 + input10 ;
    }


    var sumcal =  input11 + input12 + input13 ;
  ...
  $(".tokenizationSelect2").select2({
    placeholder: "Escribe si deseas", //placeholder
    tags: true,
    tokenSeparators: ['/',',',';'," "] 
  });
})
