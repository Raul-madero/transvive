...
$(document).ready(function () {
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <!-- <input type="text" class="form-control" id="selectdescripcion" name="selectdescripcion" readonly> -->
                                <select id="selectdescripcion" class="form-control select2bs4" style="width: 100%; text-align: left" name="selectdescripcion">
                                    <option value="">- Seleccione -</option>
    ...
    <script>
        $('#actualizaclientes').click(function(e){
            ...
            var codigo       = $('#selectdescripcion').val();
            var descripcion  = $('#inputCodigo').val();
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    if(response != 'error')
                    {
                        ...
                        $('#inputCodigo').val('');
                        $('#selectdescripcion').val(null).trigger('change');
                        $('#inputMarca').val('');
                        $('#inputCantidad').val('0');
                ...
                $.ajax({
                    ...
                    // console.log(response);
                        if(response == 0){
                            ...
                            // $('#selectdescripcion').val(data.descripcion).change(); // Notify only Select2 of changes
                            $('#inputCodigo').val(data.descripcion); 
