...
session_start();
  ...
  {
    header('Location: cargos_puestos.php');
    mysqli_close($conection);
  }
  $idrt = $_REQUEST['id'];

  $sqlact= mysqli_query($conection,"SELECT id, cargo, estatus FROM cargos WHERE id=$idrt");
  mysqli_close($conection);
        ...
        <div class="row">
          ...
          <div class="col-sm-6 d-none d-sm-block">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="cargos_puestos.php">Cargos (Puestos)</a></li>
    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Edición de Cargo (Puesto)</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <input type="text" class="form-control" id="inputId" name="inputId" value="<?php echo $id; ?>" hidden>
               
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Cargo (Puesto)</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPuesto" name="inputPuesto" placeholder="Nombre del Cargo o Puesto" value="<?php echo $cargo; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" style="width: 100%; text-align: left" id="inputEstatus" name="inputEstatus">
                          <option value="<?php echo $status; ?>" hidden><?php echo $name_estatus; ?></option>
    ...
    .fire({
     ...
     .then(resultado => {
        if (resultado.value) {
            ...
            // Dijeron que no
            //*location.reload();
            location.href = 'cargos_puestos.php';
        }
    });
...
<script>
   $('#guardar_tipoactividad').click(function(e){
       ...
       var idcr     = $('#inputId').val();
       var puesto   = $('#inputPuesto').val();
       var eestatus = $('#inputEstatus').val();

       var action       = 'AlmacenaEditPuesto';

        $.ajax({
                    url: 'includes/ajax.php',
                    type: "POST",
                    async : true,
                    data: {action:action, idcr:idcr, puesto:puesto, eestatus:eestatus},
