     ...
     <table>
                <tr> 
                    <td>
                      ...
                      <option value="Semana 52">Semana 53</option>
                      </select>
                    </td>
   ...
   <br />
           <div class="card">
              <div class="card-header">
                <h1 class="card-title">NOMINA SEMANAL</h1>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
 ...
 <script>
   $('#actualizaclientes').click(function(e){
        ...
        //var semana = document.getElementById("semana").value;
         ...
         var action     = 'DeleteEmpleadoNomSem';
 ...
 <script>
   $('#actualizaNomempleado').click(function(e){
        ...
        var action     = 'ActualizaNomEmpleado';
...
"order": [[ 1, "asc" ]],     
"bProcessing": true,
"sAjaxSource": "data/data_nominasemanal.php",
"bPaginate":true,
