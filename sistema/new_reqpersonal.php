    ...
    <center>
     ...
     <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Alta de Requisición de Personal</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-3">
                      <input type="date" class="form-control" id="inputFecharec" name="inputFecharec">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputNovacantes" name="inputNovacantes">
                    </div>
                  </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputZona" class="col-sm-2 col-form-label">Zona</label>
                          <div class="col-sm-4">
                          <input type="text" class="form-control" id="inputZona" name="inputZona">
                    </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    <label for="inputMotivo" class="col-sm-2 col-form-label">Motivo de la vacante</label>
                          ...
                          <input type="text" class="form-control" id="inputDatamotivo" name="inputDatamotivo">
                 ...
                 <div class="form-group row" >
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputHorario" name="inputHorario">
                    </div>
                     <label for="inputSueldo" class="col-sm-3 col-form-label">Sueldo de contratación</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="inputSueldo" name="inputSueldo">
                    </div>
                  </div>  
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="inputSueldoplanta" name="inputSueldoplanta">
                    </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="inputEscolaridad" name="inputEscolaridad">
                    </div>
                     <label for="inputExperiencia" class="col-sm-2 col-form-label">Experiencia</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="inputExperiencia" name="inputExperiencia">
                    </div>
                  ...
                  <div class="form-group row" style="text-align:left;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSaber" name="inputSaber">
                    </div>
                  </div>
                   <div class="form-group row" style="text-align:left;">
                    <label for="inputCubrio" class="col-sm-2 col-form-label">Se cubrió con</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="inputCubrio" name="inputCubrio">
                    </div>
                     <label for="inputCubrio" class="col-sm-2 col-form-label">Autorizado</label>
                    <div class="col-sm-2">
                      <select class="form-control" style="width: 100%; text-align: left" id="inputautorizado" name="inputautorizado">
                          <option value="">Selecciona</option>
                    ...
                    success: function(response)
                    {
                      if(response != 'error')
                        ...
                        $mensaje=(info.mensaje);
                         ...
                         .fire({
                          title: "Exito!",
                          text: "REQUISICION DE PERSONAL ALMACENADA CORRECTAMENTE",
                          icon: 'success',
