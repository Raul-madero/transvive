...
<body class="hold-transition layout-top-nav">
	...
	<!-- Main Footer -->
<!-- [Contenido HTML y estructura de página] -->
...
<!-- DataTables & Plugins: Se recomienda unificar la carga a una sola versión -->
<script src="../vendors/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="../vendors/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- ... otros scripts de DataTables -->
<!-- DataTables JS library desde CDN (verificar duplicidad) -->
...
<?php
    ...
    $sqldate = "SELECT nombre as cliente, fecha_iniciacontrato, fecha_fincontrato FROM clientes 
                WHERE DATE(fecha_fincontrato) < DATE_SUB(NOW(), INTERVAL 30 DAY) 
                AND fecha_fincontrato > '2020-01-01' AND estatus = 1";
...
?>
    <script>
        // Alert individual para cada contrato vencido
...
?>
    <script>
        // Opcional: Notificar que no hay contratos vencidos (actualmente comentado)
...
<script>
    // Gráfico de densidad utilizando Chart.js
...
<script>
    // Gráfico con Highcharts: Viajes Planeados vs Registrados
    Highcharts.chart('container', {
        chart: { type: 'bar' },
        title: { text: 'Registro de Viajes Planeados vs Registrados', align: 'left' },
        subtitle: { text: 'Año en curso', align: 'left' },
        xAxis: {
        ...
        yAxis: {
            min: 0,
            title: { text: 'Population (viajes)', align: 'high' },
            labels: { overflow: 'justify' },
            gridLineWidth: 0
        },
        tooltip: { valueSuffix: ' viajes' },
        plotOptions: {
            bar: {
                borderRadius: '50%',
...
<!-- Container 2: Gráfico de Consumo de Combustible -->
<script>
    Highcharts.chart('container2', {
        title: { text: 'Consumo de Combustible', align: 'left' },
        subtitle: { text: 'Año en curso', align: 'left' },
        xAxis: {
            categories: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre']
        },
        yAxis: { title: { text: 'Consumo por mes' } },
...
<script>
    // Gráfico con Chart.js para evaluación de tiempos y servicios
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Tiempo forma',
                backgroundColor: '#63d69f',
                borderColor: 'black',
                borderWidth: 0,
                data: []
            }, {
                label: 'Tiempo respuesta',
                backgroundColor: '#438c6c',
                borderColor: 'black',
                borderWidth: 0,
                data: []
            }, {
                label: 'Disponibilidad',
                backgroundColor: '#509c7f',
                borderColor: 'black',
                borderWidth: 0,
                data: []
            }, {
                label: 'Calidad',
                backgroundColor: '#1f794e',
                borderColor: 'black',
                borderWidth: 0,
                data: []
            }, {
...
<script>
    // Gráfico con Highcharts: Compras / Consumo de Combustible por Mes
    Highcharts.chart('container4d', {
        title: { text: 'Compras / Consumo de Combustible por Mes ', align: 'left' },
        subtitle: { text: 'Año en curso', align: 'left' },
        yAxis: { title: { text: 'Importe / Consumo' } },
        xAxis: {
...
<script>
    // Gráfico con Highcharts: Calificación de Clientes a Servicios
    Highcharts.chart('container5d', {
        chart: { type: 'column' },
        title: { text: 'Calificación de Clientes a Servicios', align: 'left' },
        subtitle: { text: 'Calificacion: 3 Excelente - 2 Bueno - 1 Regular - 0 Malo ', align: 'left' },
        xAxis: {
...
<script>
    // Gráfico con Highcharts: Calificación de Clientes a Servicios (por cliente)
