  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0"> Listado de <small>Motivos de Perdida</small></h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="new_motivop.php"><i class="fas fa-plus" style="color: green;"></i><?php echo str_repeat('&nbsp;',2);?>Nuevo</a></li>
...
"bProcessing": true,
"sAjaxSource": "data/data_motivos.php",
"bPaginate":true,
...
"aoColumns": [
{ mData: 'id', "sWidth": "5%" } ,
{ mData: 'name_motivo' ,"sWidth": "60%"},
{ mData: 'Status' ,"sWidth": "15%"},
{
                    "render": function ( data, type, full, meta ) {
        return '<a class="link_edit" style="color:#007bff;" href= \'edit_motivop.php?id=' + full.id +  '\'><i class="far fa-edit"></i> Editar</a> | <a id="delete_cliente" data-id=\'' + full.id +  '\' href="javascript:void(0)" class="link_delete" style="color:red" ><i class="far fa-trash-alt"></i> Borrar</a>';
    }
